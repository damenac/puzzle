...
/**
 * This is the item provider adapter for a {@link vm.LanguageModule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LanguageModuleItemProvider extends PNamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VmPackage.Literals.LANGUAGE_MODULE__AS);
			childrenFeatures.add(VmPackage.Literals.LANGUAGE_MODULE__SEM);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(VmPackage.Literals.LANGUAGE_MODULE__AS,
				 VmFactory.eINSTANCE.createAbstractSyntax()));

		newChildDescriptors.add
			(createChildParameter
				(VmPackage.Literals.LANGUAGE_MODULE__SEM,
				 VmFactory.eINSTANCE.createSemantics()));
	}
