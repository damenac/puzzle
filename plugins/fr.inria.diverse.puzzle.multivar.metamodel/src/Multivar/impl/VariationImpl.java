 ...
 *   <li>{@link Multivar.impl.VariationImpl#isDefault <em>Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariationImpl extends NamedElementImpl implements Variation {
	...
	public void setDefault(boolean newDefault) {
		...
		default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MultivarPackage.VARIATION__DEFAULT, oldDefault, default_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MultivarPackage.VARIATION__MODULE:
				return getModule();
			case MultivarPackage.VARIATION__DEFAULT:
				return isDefault();
		}
