...
/**
 * Prints the internal dependencies graph i.e., dependencies among all the constructs of the family.
 * @author David Mendez-Acuna
 *
 */
public class InternalDependenciesGraph implements SpecialFamilySyntacticChart {
	...
	public String getVariablesDeclaration(ArrayList<Language> languages, ConceptComparison conceptComparisonOperator) throws Exception{
		...
		(new DefaultParition()).graphPartition(dependenciesGraph, membersConceptList, conceptComparisonOperator);
