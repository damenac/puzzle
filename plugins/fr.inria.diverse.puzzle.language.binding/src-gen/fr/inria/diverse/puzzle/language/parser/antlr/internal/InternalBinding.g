...
@parser::members {
    ...
    public InternalBindingParser(TokenStream input, BindingGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected BindingGrammarAccess getGrammarAccess() {
...
entryRuleLanguageBinding returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getLanguageBindingRule()); }
	 iv_ruleLanguageBinding=ruleLanguageBinding 
	 { $current=$iv_ruleLanguageBinding.current; } 
	 EOF 
;

// Rule LanguageBinding
ruleLanguageBinding returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((	otherlv_0='package' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getLanguageBindingAccess().getPackageKeyword_0_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getLanguageBindingAccess().getNameQualifiedNameParserRuleCall_0_1_0()); 
	    }
...
(
		lv_left_2_0=RULE_ID
		{
			newLeafNode(lv_left_2_0, grammarAccess.getBindingAccess().getLeftIDTerminalRuleCall_2_0()); 
		}
		{
	        if ($current==null) {
...
(
		...
		{
			newLeafNode(lv_right_4_0, grammarAccess.getBindingAccess().getRightIDTerminalRuleCall_4_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getBindingRule());
