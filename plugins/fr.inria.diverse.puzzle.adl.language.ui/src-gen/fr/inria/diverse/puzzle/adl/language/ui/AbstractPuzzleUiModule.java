...
/**
 * Manual modifications go to {fr.inria.diverse.puzzle.adl.language.ui.PuzzleUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractPuzzleUiModule extends org.eclipse.xtext.xbase.ui.DefaultXbaseUiModule {
	
	public AbstractPuzzleUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(fr.inria.diverse.puzzle.adl.language.parser.antlr.internal.InternalPuzzleLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return fr.inria.diverse.puzzle.adl.language.ui.labeling.PuzzleLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(fr.inria.diverse.puzzle.adl.language.ui.labeling.PuzzleDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return fr.inria.diverse.puzzle.adl.language.ui.outline.PuzzleOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return fr.inria.diverse.puzzle.adl.language.ui.quickfix.PuzzleQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return fr.inria.diverse.puzzle.adl.language.ui.contentassist.PuzzleProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return fr.inria.diverse.puzzle.adl.language.ui.contentassist.antlr.PuzzleParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(fr.inria.diverse.puzzle.adl.language.ui.contentassist.antlr.internal.InternalPuzzleLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(fr.inria.diverse.puzzle.adl.language.ui.contentassist.antlr.internal.InternalPuzzleLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(fr.inria.diverse.puzzle.adl.language.ui.contentassist.antlr.internal.InternalPuzzleLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.codetemplates.ui.partialEditing.IPartialContentAssistParser> bindIPartialContentAssistParser() {
		return fr.inria.diverse.puzzle.adl.language.ui.contentassist.antlr.PartialPuzzleContentAssistParser.class;
	}
