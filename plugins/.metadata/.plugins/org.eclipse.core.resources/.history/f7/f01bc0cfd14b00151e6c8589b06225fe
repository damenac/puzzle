...
public class MaintananceCosts implements ChartMetric {
	...
	public String getVariablesDeclaration(ArrayList<Language> languages,
		...
		String javaScriptData = "var barsDataMaintainanceCosts = {\n";
	...
	public String getWindow(ArrayList<Language> languages) {
		String javaScriptWindow = "    var ctxLineChartMaintaince = document.getElementById(\"chart-maintainance-costs\").getContext(\"2d\");";
		javaScriptWindow += "    window.myLineChartMaintaince = new Chart(ctxLineChartMaintaince).Line(barsDataMaintainanceCosts,{";
