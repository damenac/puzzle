 ...
 *   <li>{@link vm.impl.PAbstractSyntaxImpl#getEcoreRequiredInterfacePath <em>Ecore Required Interface Path</em>}</li>
 *   <li>{@link vm.impl.PAbstractSyntaxImpl#getEcoreProvidedInterfacePath <em>Ecore Provided Interface Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PAbstractSyntaxImpl extends MinimalEObjectImpl.Container implements PAbstractSyntax {
	...
	public void setEcoreRequiredInterfacePath(String newEcoreRequiredInterfacePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmPackage.PABSTRACT_SYNTAX__ECORE_REQUIRED_INTERFACE_PATH, oldEcoreRequiredInterfacePath, ecoreRequiredInterfacePath));
	}
	...
	public void setEcoreProvidedInterfacePath(String newEcoreProvidedInterfacePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmPackage.PABSTRACT_SYNTAX__ECORE_PROVIDED_INTERFACE_PATH, oldEcoreProvidedInterfacePath, ecoreProvidedInterfacePath));
	}
