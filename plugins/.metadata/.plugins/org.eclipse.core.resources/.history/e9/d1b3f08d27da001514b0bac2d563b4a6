 ...
 * <ul>
 *   <li>{@link fr.inria.diverse.puzzle.adl.language.puzzle.MelangeImport#getMelangeFile <em>Melange File</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.diverse.puzzle.adl.language.puzzle.PuzzlePackage#getMelangeImport()
 * @model
 * @generated
 */
public interface MelangeImport extends EObject
{
   ...
   * @see fr.inria.diverse.puzzle.adl.language.puzzle.PuzzlePackage#getMelangeImport_MelangeFile()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.inria.diverse.puzzle.adl.language.puzzle.MelangeImport#getMelangeFile <em>Melange File</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
