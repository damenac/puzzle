 ...
 * @generated
 */
public class PuzzleADLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PuzzleADLPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzleADLPackage.LANGUAGE_ARCHITECTURE: {
				LanguageArchitecture languageArchitecture = (LanguageArchitecture)theEObject;
				T result = caseLanguageArchitecture(languageArchitecture);
				if (result == null) result = caseNamedElement(languageArchitecture);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzleADLPackage.LANGUAGE_MODULE: {
				LanguageModule languageModule = (LanguageModule)theEObject;
				T result = caseLanguageModule(languageModule);
				if (result == null) result = caseNamedElement(languageModule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzleADLPackage.REQUIRED_INTERFACE: {
				RequiredInterface requiredInterface = (RequiredInterface)theEObject;
				T result = caseRequiredInterface(requiredInterface);
				if (result == null) result = caseNamedElement(requiredInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzleADLPackage.PROVIDED_INTERFACE: {
				ProvidedInterface providedInterface = (ProvidedInterface)theEObject;
				T result = caseProvidedInterface(providedInterface);
				if (result == null) result = caseNamedElement(providedInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PuzzleADLPackage.INTERFACE_BINDING: {
				InterfaceBinding interfaceBinding = (InterfaceBinding)theEObject;
				T result = caseInterfaceBinding(interfaceBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Language Architecture</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Language Architecture</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLanguageArchitecture(LanguageArchitecture object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Interface Binding</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Interface Binding</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
