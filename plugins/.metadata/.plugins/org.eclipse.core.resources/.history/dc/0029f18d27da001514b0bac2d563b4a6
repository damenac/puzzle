...
public class PuzzleSyntacticSequencer extends AbstractSyntacticSequencer {

	protected PuzzleGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (PuzzleGrammarAccess) access;
