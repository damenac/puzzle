 ...
 * generated by Xtext
 */
package fr.inria.diverse.melange.ui.contentassist.antlr;
...
public class MelangeParser extends AbstractContentAssistParser {
	...
	@Override
	protected fr.inria.diverse.melange.ui.contentassist.antlr.internal.InternalMelangeParser createParser() {
		fr.inria.diverse.melange.ui.contentassist.antlr.internal.InternalMelangeParser result = new fr.inria.diverse.melange.ui.contentassist.antlr.internal.InternalMelangeParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLanguageAccess().getGroup_0_3(), "rule__Language__Group_0_3__0");
					put(grammarAccess.getLanguageAccess().getGroup_0_3_2(), "rule__Language__Group_0_3_2__0");
					put(grammarAccess.getLanguageAccess().getGroup_0_4(), "rule__Language__Group_0_4__0");
					put(grammarAccess.getLanguageAccess().getGroup_0_4_2(), "rule__Language__Group_0_4_2__0");
					put(grammarAccess.getLanguageAccess().getGroup_0_6(), "rule__Language__Group_0_6__0");
					put(grammarAccess.getLanguageAccess().getGroup_0_6_2_0(), "rule__Language__Group_0_6_2_0__0");
					put(grammarAccess.getLanguageAccess().getGroup_0_6_2_1(), "rule__Language__Group_0_6_2_1__0");
					put(grammarAccess.getLanguageAccess().getGroup_2(), "rule__Language__Group_2__0");
					put(grammarAccess.getLanguageAccess().getGroup_2_0(), "rule__Language__Group_2_0__0");
					put(grammarAccess.getLanguageAccess().getGroup_2_0_2(), "rule__Language__Group_2_0_2__0");
					...
					put(grammarAccess.getXbaseTransformationAccess().getGroup(), "rule__XbaseTransformation__Group__0");
					put(grammarAccess.getXbaseTransformationAccess().getGroup_5(), "rule__XbaseTransformation__Group_5__0");
					...
					put(grammarAccess.getImportAccess().getGroup_2_1_1(), "rule__Import__Group_2_1_1__0");
					...
					put(grammarAccess.getMergeAccess().getGroup_2(), "rule__Merge__Group_2__0");
					put(grammarAccess.getSliceAccess().getGroup(), "rule__Slice__Group__0");
					put(grammarAccess.getSliceAccess().getGroup_5(), "rule__Slice__Group_5__0");
					put(grammarAccess.getSliceAccess().getGroup_7(), "rule__Slice__Group_7__0");
//					put(grammarAccess.getWeaveAccess().getGroup(), "rule__Weave__Group__0");
					...
					put(grammarAccess.getLanguageAccess().getImplementsAssignment_0_3_1(), "rule__Language__ImplementsAssignment_0_3_1");
					put(grammarAccess.getLanguageAccess().getImplementsAssignment_0_3_2_1(), "rule__Language__ImplementsAssignment_0_3_2_1");
					put(grammarAccess.getLanguageAccess().getRequiresAssignment_0_4_1(), "rule__Language__RequiresAssignment_0_4_1");
					put(grammarAccess.getLanguageAccess().getRequiresAssignment_0_4_2_1(), "rule__Language__RequiresAssignment_0_4_2_1");
					put(grammarAccess.getLanguageAccess().getResourceTypeAssignment_0_6_1(), "rule__Language__ResourceTypeAssignment_0_6_1");
					put(grammarAccess.getLanguageAccess().getResourceUriAssignment_0_6_2_0_1(), "rule__Language__ResourceUriAssignment_0_6_2_0_1");
					put(grammarAccess.getLanguageAccess().getXtextSetupRefAssignment_0_6_2_1_1(), "rule__Language__XtextSetupRefAssignment_0_6_2_1_1");
					put(grammarAccess.getLanguageAccess().getOperatorsAssignment_1(), "rule__Language__OperatorsAssignment_1");
					put(grammarAccess.getLanguageAccess().getExactTypeNameAssignment_2_0_1(), "rule__Language__ExactTypeNameAssignment_2_0_1");
					put(grammarAccess.getLanguageAccess().getExactTypeUriAssignment_2_0_2_1(), "rule__Language__ExactTypeUriAssignment_2_0_2_1");
					...
					put(grammarAccess.getXbaseTransformationAccess().getMainAssignment_0(), "rule__XbaseTransformation__MainAssignment_0");
					put(grammarAccess.getXbaseTransformationAccess().getReturnTypeRefAssignment_2(), "rule__XbaseTransformation__ReturnTypeRefAssignment_2");
					put(grammarAccess.getXbaseTransformationAccess().getNameAssignment_3(), "rule__XbaseTransformation__NameAssignment_3");
					put(grammarAccess.getXbaseTransformationAccess().getParametersAssignment_5_0(), "rule__XbaseTransformation__ParametersAssignment_5_0");
					put(grammarAccess.getXbaseTransformationAccess().getParametersAssignment_5_1_1(), "rule__XbaseTransformation__ParametersAssignment_5_1_1");
					put(grammarAccess.getXbaseTransformationAccess().getBodyAssignment_7(), "rule__XbaseTransformation__BodyAssignment_7");
					put(grammarAccess.getMappingAccess().getFromAssignment_1(), "rule__Mapping__FromAssignment_1");
					put(grammarAccess.getMappingAccess().getToAssignment_3(), "rule__Mapping__ToAssignment_3");
...
//					put(grammarAccess.getWeaveAccess().getAspectTypeRefAssignment_1(), "rule__Weave__AspectTypeRefAssignment_1");
					...
					put(grammarAccess.getLanguageAccess().getUnorderedGroup(), "rule__Language__UnorderedGroup");
					put(grammarAccess.getEcoreModelTypeAccess().getUnorderedGroup(), "rule__EcoreModelType__UnorderedGroup");
				}
			};
		}
