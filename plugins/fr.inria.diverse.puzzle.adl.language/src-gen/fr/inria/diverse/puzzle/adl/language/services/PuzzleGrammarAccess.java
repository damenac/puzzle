 ...
 * generated by Xtext
 */
package fr.inria.diverse.puzzle.adl.language.services;
...
@Singleton
public class PuzzleGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class LanguageBindingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "LanguageBinding");
	...
	@Inject
	public PuzzleGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.inria.diverse.puzzle.adl.language.Puzzle".equals(grammar.getName())) {
				return grammar;
			}
