...
public class LanguageFeatureItemProvider extends NamedElementItemProvider {
	...
	/**
	 * This adds a property descriptor for the Implementation Module feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addImplementationModulePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LanguageFeature_implementationModule_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LanguageFeature_implementationModule_feature", "_UI_LanguageFeature_type"),
