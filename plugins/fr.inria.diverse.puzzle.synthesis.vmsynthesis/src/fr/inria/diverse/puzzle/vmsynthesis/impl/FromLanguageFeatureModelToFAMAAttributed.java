 ...
 *
 */
public class FromLanguageFeatureModelToFAMAAttributed {

	// -----------------------------------------------------------
	// Attributes
	// -----------------------------------------------------------
	
	private static FromLanguageFeatureModelToFAMAAttributed instance;
	
	// -----------------------------------------------------------
	// Constructor and singleton
	// -----------------------------------------------------------
	
	private FromLanguageFeatureModelToFAMAAttributed(){
		
	}
	
	public static FromLanguageFeatureModelToFAMAAttributed getInstance(){
		if(instance == null)
			instance = new FromLanguageFeatureModelToFAMAAttributed();
		return instance;
	}
	 ...
	 * @return
	 */
	public FAMAAttributedFeatureModel fromLanguageFeatureModelToFAMA(
