 ...
 * generated by Xtext
 */
package fr.inria.diverse.puzzle.formatting;
...
public class MutivarFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private MutivarGrammarAccess _mutivarGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._mutivarGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._mutivarGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._mutivarGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._mutivarGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._mutivarGrammarAccess.getML_COMMENTRule();
