...
import ExpressionPck.ExpressionPckFactory;
 ...
 * @generated
 */
public class ExpressionPckPackageImpl extends EPackageImpl implements ExpressionPckPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ExpressionPck.ExpressionPckPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ExpressionPckPackageImpl() {
		super(eNS_URI, ExpressionPckFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ExpressionPckPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ExpressionPckPackage init() {
		if (isInited) return (ExpressionPckPackage)EPackage.Registry.INSTANCE.getEPackage(ExpressionPckPackage.eNS_URI);

		// Obtain or create and register package
		ExpressionPckPackageImpl theExpressionPckPackage = (ExpressionPckPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ExpressionPckPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ExpressionPckPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theExpressionPckPackage.createPackageContents();

		// Initialize created meta-data
		theExpressionPckPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theExpressionPckPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ExpressionPckPackage.eNS_URI, theExpressionPckPackage);
		return theExpressionPckPackage;
	}
	 ...
	 * @generated
	 */
	public ExpressionPckFactory getExpressionPckFactory() {
		return (ExpressionPckFactory)getEFactoryInstance();
	}
