 ...
 * @generated
 */
public class ComplextriggersSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComplextriggersPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComplextriggersPackage.NOT_TRIGGER: {
			...
			case ComplextriggersPackage.AND_TRIGGER: {
			...
			case ComplextriggersPackage.OR_TRIGGER: {
