...
public interface TriggersPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TRIGGER___EVAL_TRIGGER__MAP = 0;
	 ...
	 * @ordered
	 */
	int NOT_TRIGGER___EVAL_TRIGGER__MAP = TRIGGER___EVAL_TRIGGER__MAP;
	 ...
	 * @ordered
	 */
	int AND_TRIGGER___EVAL_TRIGGER__MAP = TRIGGER___EVAL_TRIGGER__MAP;
	 ...
	 * @ordered
	 */
	int OR_TRIGGER___EVAL_TRIGGER__MAP = TRIGGER___EVAL_TRIGGER__MAP;
	...
	/**
	 * Returns the meta object for the '{@link triggers.Trigger#evalTrigger(java.util.Map) <em>Eval Trigger</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Eval Trigger</em>' operation.
	 * @see triggers.Trigger#evalTrigger(java.util.Map)
	 * @generated
	 */
	EOperation getTrigger__EvalTrigger__Map();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation TRIGGER___EVAL_TRIGGER__MAP = eINSTANCE.getTrigger__EvalTrigger__Map();
