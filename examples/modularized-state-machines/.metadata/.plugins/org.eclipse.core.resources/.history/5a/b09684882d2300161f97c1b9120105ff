 ...
 * <ul>
 *   <li>{@link actionscripting.Wait#getMiliseconds <em>Miliseconds</em>}</li>
 * </ul>
 * </p>
 *
 * @see actionscripting.ActionscriptingPackage#getWait()
 * @model
 * @generated
 */
public interface Wait extends Statement {
	 ...
	 * @see actionscripting.ActionscriptingPackage#getWait_Miliseconds()
	 * @model required="true"
	 * @generated
	 */
	long getMiliseconds();
	...
	/**
	 * Sets the value of the '{@link actionscripting.Wait#getMiliseconds <em>Miliseconds</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
