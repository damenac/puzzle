...
public class StringLitAspect extends LiteralAspect {
  ...
  public static Object eval(final StringLit _self, final Hashtable<String, Object> context) {
    fr.inria.diverse.puzzle.examples.expressions.semantics.StringLitAspectStringLitAspectProperties _self_ = fr.inria.diverse.puzzle.examples.expressions.semantics.StringLitAspectStringLitAspectContext.getSelf(_self);
    Object result = null;
