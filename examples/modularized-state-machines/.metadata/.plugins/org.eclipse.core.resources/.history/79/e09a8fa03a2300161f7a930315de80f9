...
import actionscripting.ActionscriptingFactory;
...
import actionscripting.ConsoleOutput;
 ...
 * @generated
 */
public class ActionscriptingPackageImpl extends EPackageImpl implements ActionscriptingPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see actionscripting.ActionscriptingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ActionscriptingPackageImpl() {
		super(eNS_URI, ActionscriptingFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ActionscriptingPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ActionscriptingPackage init() {
		if (isInited) return (ActionscriptingPackage)EPackage.Registry.INSTANCE.getEPackage(ActionscriptingPackage.eNS_URI);

		// Obtain or create and register package
		ActionscriptingPackageImpl theActionscriptingPackage = (ActionscriptingPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ActionscriptingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ActionscriptingPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theActionscriptingPackage.createPackageContents();

		// Initialize created meta-data
		theActionscriptingPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theActionscriptingPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ActionscriptingPackage.eNS_URI, theActionscriptingPackage);
		return theActionscriptingPackage;
	}
	 ...
	 * @generated
	 */
	public ActionscriptingFactory getActionscriptingFactory() {
		return (ActionscriptingFactory)getEFactoryInstance();
	}
