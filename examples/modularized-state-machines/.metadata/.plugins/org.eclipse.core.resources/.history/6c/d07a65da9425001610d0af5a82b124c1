...
import static extension fr.inria.diverse.puzzle.examples.fsm.semantics.StateAspect.*
import static extension fr.inria.diverse.puzzle.examples.fsm.semantics.TransitionAspect.*
import static extension fr.inria.diverse.puzzle.examples.fsm.semantics.TriggerAspect.*
