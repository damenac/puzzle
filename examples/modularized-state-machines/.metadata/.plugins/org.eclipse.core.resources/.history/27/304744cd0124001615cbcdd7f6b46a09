 ...
 * <ul>
 *   <li>{@link triggers.impl.NotTriggerImpl#getTrigger <em>Trigger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotTriggerImpl extends TriggerImpl implements NotTrigger {
	...
	protected EClass eStaticClass() {
		return TriggersPackage.Literals.NOT_TRIGGER;
	}
		...
		if (trigger != null && trigger.eIsProxy()) {
			...
			if (trigger != oldTrigger) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TriggersPackage.NOT_TRIGGER__TRIGGER, oldTrigger, trigger));
			}
		}
		return trigger;
	}
	...
	public void setTrigger(Trigger newTrigger) {
		...
		trigger = newTrigger;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TriggersPackage.NOT_TRIGGER__TRIGGER, oldTrigger, trigger));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TriggersPackage.NOT_TRIGGER__TRIGGER:
