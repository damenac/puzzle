...
public class ArithmeticExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final ArithmeticExpression _self, final Hashtable<String, Object> context) {
    fr.inria.diverse.puzzle.examples.expressions.semantics.ArithmeticExpressionAspectArithmeticExpressionAspectProperties _self_ = fr.inria.diverse.puzzle.examples.expressions.semantics.ArithmeticExpressionAspectArithmeticExpressionAspectContext.getSelf(_self);
    Object result = null;
