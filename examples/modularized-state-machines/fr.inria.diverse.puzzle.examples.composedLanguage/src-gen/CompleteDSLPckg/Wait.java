 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.Wait#getMiliseconds <em>Miliseconds</em>}</li>
 * </ul>
 * </p>
 *
 * @see CompleteDSLPckg.CompleteDSLPckgPackage#getWait()
 * @model
 * @generated
 */
public interface Wait extends Statement {
	 ...
	 * @see CompleteDSLPckg.CompleteDSLPckgPackage#getWait_Miliseconds()
	 * @model
	 * @generated
	 */
	long getMiliseconds();
	...
	/**
	 * Sets the value of the '{@link CompleteDSLPckg.Wait#getMiliseconds <em>Miliseconds</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
