...
public class CompleteDSLPckgPackageImpl extends EPackageImpl implements CompleteDSLPckgPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getRegion_OwnerStateMachine(), this.getStateMachine(), null, "ownerStateMachine", null, 0, 1, Region.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
