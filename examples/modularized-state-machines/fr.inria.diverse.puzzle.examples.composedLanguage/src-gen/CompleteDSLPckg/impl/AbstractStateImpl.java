...
public abstract class AbstractStateImpl extends NamedElementImpl implements AbstractState {
	...
	public EList<Transition> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectResolvingEList<Transition>(Transition.class, this, CompleteDSLPckgPackage.ABSTRACT_STATE__INCOMING);
		}
		return incoming;
	}
	...
	public EList<Transition> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectResolvingEList<Transition>(Transition.class, this, CompleteDSLPckgPackage.ABSTRACT_STATE__OUTGOING);
		}
		return outgoing;
	}
		...
		if (ownerRegion != null && ownerRegion.eIsProxy()) {
			...
			if (ownerRegion != oldOwnerRegion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.ABSTRACT_STATE__OWNER_REGION, oldOwnerRegion, ownerRegion));
			}
		}
		return ownerRegion;
	}
	...
	public void setOwnerRegion(Region newOwnerRegion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.ABSTRACT_STATE__OWNER_REGION, oldOwnerRegion, ownerRegion));
	}
