...
import CompleteDSL.ArithmeticExpressionAspectArithmeticExpressionAspectProperties;
...
public class ArithmeticExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final ArithmeticExpression _self, final Hashtable<String, Object> context) {
    CompleteDSL.ArithmeticExpressionAspectArithmeticExpressionAspectProperties _self_ = CompleteDSL.ArithmeticExpressionAspectArithmeticExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof CompleteDSLPckg.ArithmeticExpression){
    result = CompleteDSL.ArithmeticExpressionAspect._privk3_eval(_self_, (CompleteDSLPckg.ArithmeticExpression)_self,context);
