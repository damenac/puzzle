 ...
 * <ul>
 *   <li>{@link actionscripting.impl.VarRefImpl#getVarRef <em>Var Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VarRefImpl extends ExpressionImpl implements VarRef {
	...
	protected EClass eStaticClass() {
		return ActionscriptingPackage.Literals.VAR_REF;
	}
	...
	public void setVarRef(String newVarRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActionscriptingPackage.VAR_REF__VAR_REF, oldVarRef, varRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActionscriptingPackage.VAR_REF__VAR_REF:
				return getVarRef();
		}
