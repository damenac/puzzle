...
public class AndTriggerAspect {
  ...
  public static boolean evalTrigger(final AndTrigger _self, final EList<String> events) {
    fr.inria.diverse.puzzle.examples.newtriggers.semantics.AndTriggerAspectAndTriggerAspectProperties _self_ = fr.inria.diverse.puzzle.examples.newtriggers.semantics.AndTriggerAspectAndTriggerAspectContext.getSelf(_self);
    Object result = null;
