...
public class AndTriggerAspectAndTriggerAspectContext {
  ...
  public static AndTriggerAspectAndTriggerAspectProperties getSelf(final AndTrigger _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new fr.inria.diverse.puzzle.examples.newtriggers.semantics.AndTriggerAspectAndTriggerAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<AndTrigger, AndTriggerAspectAndTriggerAspectProperties> map = new java.util.WeakHashMap<complextriggers.AndTrigger, fr.inria.diverse.puzzle.examples.newtriggers.semantics.AndTriggerAspectAndTriggerAspectProperties>();
