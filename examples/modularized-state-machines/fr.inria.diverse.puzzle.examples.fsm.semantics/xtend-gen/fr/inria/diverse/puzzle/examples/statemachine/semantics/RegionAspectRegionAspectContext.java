...
public class RegionAspectRegionAspectContext {
  ...
  public static RegionAspectRegionAspectProperties getSelf(final Region _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new fr.inria.diverse.puzzle.examples.statemachine.semantics.RegionAspectRegionAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Region, RegionAspectRegionAspectProperties> map = new java.util.WeakHashMap<fsm.Region, fr.inria.diverse.puzzle.examples.statemachine.semantics.RegionAspectRegionAspectProperties>();
