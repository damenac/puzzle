...
public class StateAspect {
  public static void entryState(final State _self, final Hashtable<String, Object> context) {
    fr.inria.diverse.puzzle.examples.statemachine.semantics.StateAspectStateAspectProperties _self_ = fr.inria.diverse.puzzle.examples.statemachine.semantics.StateAspectStateAspectContext.getSelf(_self);
