 ...
 * <ul>
 *   <li>{@link hfsm.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends AbstractStateImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return HfsmPackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HfsmPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HfsmPackage.PSEUDOSTATE__KIND:
				return getKind();
		}
