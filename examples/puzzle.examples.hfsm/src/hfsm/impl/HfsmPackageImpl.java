 ...
 * @generated
 */
public class HfsmPackageImpl extends EPackageImpl implements HfsmPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see hfsm.HfsmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private HfsmPackageImpl() {
		super(eNS_URI, HfsmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link HfsmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static HfsmPackage init() {
		if (isInited) return (HfsmPackage)EPackage.Registry.INSTANCE.getEPackage(HfsmPackage.eNS_URI);

		// Obtain or create and register package
		HfsmPackageImpl theHfsmPackage = (HfsmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HfsmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HfsmPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theHfsmPackage.createPackageContents();

		// Initialize created meta-data
		theHfsmPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theHfsmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(HfsmPackage.eNS_URI, theHfsmPackage);
		return theHfsmPackage;
	}
	 ...
	 * @generated
	 */
	public HfsmFactory getHfsmFactory() {
		return (HfsmFactory)getEFactoryInstance();
	}
