...
public class FsmFactoryImpl extends EFactoryImpl implements FsmFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FsmPackage.RELATIONAL_CONSTRAINT: return createRelationalConstraint();
			case FsmPackage.PROGRAM: return createProgram();
			case FsmPackage.CONDITIONAL: return createConditional();
			case FsmPackage.LOOP: return createLoop();
			case FsmPackage.VAR_DECL: return createVarDecl();
			case FsmPackage.INTEGER_LIT: return createIntegerLit();
			case FsmPackage.STRING_LIT: return createStringLit();
			case FsmPackage.BOOL_LIT: return createBoolLit();
			case FsmPackage.ARITHMETIC_EXPRESSION: return createArithmeticExpression();
			case FsmPackage.RELATIONAL_EXPRESSION: return createRelationalExpression();
			case FsmPackage.VAR_REFERENCE: return createVarReference();
			case FsmPackage.CONSOLE_OUTPUT: return createConsoleOutput();
			case FsmPackage.PRINTLN: return createPrintln();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case FsmPackage.PSEUDOSTATE_KIND:
				return createPseudostateKindFromString(eDataType, initialValue);
			case FsmPackage.ARITHMETIC_OPERATOR:
				return createArithmeticOperatorFromString(eDataType, initialValue);
			case FsmPackage.RELATIONAL_OPERATOR:
