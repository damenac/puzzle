...
import fsm.Literal;
import fsmaspects.LiteralAspectLiteralAspectProperties;
...
public class LiteralAspectLiteralAspectContext {
  ...
  public static LiteralAspectLiteralAspectProperties getSelf(final Literal _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new fsmaspects.LiteralAspectLiteralAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Literal, LiteralAspectLiteralAspectProperties> map = new java.util.WeakHashMap<fsm.Literal, fsmaspects.LiteralAspectLiteralAspectProperties>();
