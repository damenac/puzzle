...
import fsmaspects.TransitionAspectTransitionAspectProperties;
...
public class TransitionAspect {
  public static void evalTransition(final Transition _self, final Hashtable<String, Object> context) {
    fsmaspects.TransitionAspectTransitionAspectProperties _self_ = fsmaspects.TransitionAspectTransitionAspectContext.getSelf(_self);
