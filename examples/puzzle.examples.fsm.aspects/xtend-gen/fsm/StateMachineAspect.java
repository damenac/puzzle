...
import fsm.TransitionAspect;
import fsm.Trigger;
import fsm.TriggerAspect;
...
public class StateMachineAspect {
  ...
  public static void evalStateMachine(final StateMachine _self) {
    fsm.StateMachineAspectStateMachineAspectProperties _self_ = fsm.StateMachineAspectStateMachineAspectContext.getSelf(_self);
