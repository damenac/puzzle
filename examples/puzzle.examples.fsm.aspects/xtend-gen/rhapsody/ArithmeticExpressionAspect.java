...
import rhapsody.ArithmeticExpressionAspectArithmeticExpressionAspectProperties;
...
public class ArithmeticExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final ArithmeticExpression _self, final Hashtable<String, Object> context) {
    rhapsody.ArithmeticExpressionAspectArithmeticExpressionAspectProperties _self_ = rhapsody.ArithmeticExpressionAspectArithmeticExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof rhapsody.ArithmeticExpression){
    result = rhapsody.ArithmeticExpressionAspect._privk3_eval(_self_, (rhapsody.ArithmeticExpression)_self,context);
