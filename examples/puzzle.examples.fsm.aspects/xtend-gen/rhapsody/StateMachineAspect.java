...
public class StateMachineAspect {
  ...
  public static void evalStateMachine(final StateMachine _self) {
    rhapsody.StateMachineAspectStateMachineAspectProperties _self_ = rhapsody.StateMachineAspectStateMachineAspectContext.getSelf(_self);
