...
public class RelationalExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final RelationalExpression _self, final Hashtable<String, Object> context) {
    rhapsody.RelationalExpressionAspectRelationalExpressionAspectProperties _self_ = rhapsody.RelationalExpressionAspectRelationalExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof rhapsody.RelationalExpression){
    result = rhapsody.RelationalExpressionAspect._privk3_eval(_self_, (rhapsody.RelationalExpression)_self,context);
