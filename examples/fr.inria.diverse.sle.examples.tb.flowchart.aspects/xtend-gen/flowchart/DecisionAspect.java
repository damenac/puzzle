...
public class DecisionAspect {
  public static void eval(final Decision _self) {
    flowchart.DecisionAspectDecisionAspectProperties _self_ = flowchart.DecisionAspectDecisionAspectContext.getSelf(_self);
    _privk3_eval(_self_, _self);
  }
  
  protected static void _privk3_eval(final DecisionAspectDecisionAspectProperties _self_, final Decision _self) {
  }
}
