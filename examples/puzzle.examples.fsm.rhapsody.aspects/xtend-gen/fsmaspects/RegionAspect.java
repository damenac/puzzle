...
import fsm.Trigger;
import fsmaspects.RegionAspectRegionAspectProperties;
import fsmaspects.StateAspect;
import fsmaspects.TransitionAspect;
...
public class RegionAspect {
  public static void initRegion(final Region _self, final Hashtable<String, Object> context) {
    fsmaspects.RegionAspectRegionAspectProperties _self_ = fsmaspects.RegionAspectRegionAspectContext.getSelf(_self);
