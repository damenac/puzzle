...
public class StringLitAspectStringLitAspectContext {
  ...
  public static StringLitAspectStringLitAspectProperties getSelf(final StringLit _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new FSMFlowchart.expression.StringLitAspectStringLitAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<StringLit, StringLitAspectStringLitAspectProperties> map = new java.util.WeakHashMap<ExpressionModule.StringLit, FSMFlowchart.expression.StringLitAspectStringLitAspectProperties>();
