...
public class LiteralAspectLiteralAspectContext {
  ...
  public static LiteralAspectLiteralAspectProperties getSelf(final Literal _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new FSMFlowchart.expression.LiteralAspectLiteralAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Literal, LiteralAspectLiteralAspectProperties> map = new java.util.WeakHashMap<ExpressionModule.Literal, FSMFlowchart.expression.LiteralAspectLiteralAspectProperties>();
