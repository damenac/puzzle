 ...
 * @generated
 */
public class FlowchartpckSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FlowchartpckPackage.DECISION: {
			...
			case FlowchartpckPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartpckPackage.RELATIONAL_CONSTRAINT: {
			...
			case FlowchartpckPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartpckPackage.LITERAL: {
			...
			case FlowchartpckPackage.INTEGER_LIT: {
			...
			case FlowchartpckPackage.STRING_LIT: {
			...
			case FlowchartpckPackage.BOOL_LIT: {
			...
			case FlowchartpckPackage.ARITHMETIC_EXPRESSION: {
			...
			case FlowchartpckPackage.RELATIONAL_EXPRESSION: {
			...
			case FlowchartpckPackage.VAR_REFERENCE: {
