...
public class RelationalExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final RelationalExpression _self, final Hashtable<String, Object> context) {
    flowchartaspects.RelationalExpressionAspectRelationalExpressionAspectProperties _self_ = flowchartaspects.RelationalExpressionAspectRelationalExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof flowchartpck.RelationalExpression){
    result = flowchartaspects.RelationalExpressionAspect._privk3_eval(_self_, (flowchartpck.RelationalExpression)_self,context);
