...
public class ArithmeticExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final ArithmeticExpression _self, final Hashtable<String, Object> context) {
    flowchartaspects.ArithmeticExpressionAspectArithmeticExpressionAspectProperties _self_ = flowchartaspects.ArithmeticExpressionAspectArithmeticExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof flowchartpck.ArithmeticExpression){
    result = flowchartaspects.ArithmeticExpressionAspect._privk3_eval(_self_, (flowchartpck.ArithmeticExpression)_self,context);
