 ...
 * <ul>
 *   <li>{@link Actions.IntermediateActions.impl.LinkEndDataImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Actions.IntermediateActions.impl.LinkEndDataImpl#getEnd <em>End</em>}</li>
 *   <li>{@link Actions.IntermediateActions.impl.LinkEndDataImpl#getQualifier <em>Qualifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LinkEndDataImpl extends ElementImpl implements LinkEndData {
	...
	public EList<QualifierValue> getQualifier() {
		if (qualifier == null) {
			qualifier = new EObjectContainmentEList<QualifierValue>(QualifierValue.class, this, IntermediateActionsPackage.LINK_END_DATA__QUALIFIER);
		}
		return qualifier;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case IntermediateActionsPackage.LINK_END_DATA__QUALIFIER:
