 ...
 * <ul>
 *   <li>{@link Actions.IntermediateActions.impl.LinkEndCreationDataImpl#isIsReplaceAll <em>Is Replace All</em>}</li>
 *   <li>{@link Actions.IntermediateActions.impl.LinkEndCreationDataImpl#getInsertAt <em>Insert At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkEndCreationDataImpl extends LinkEndDataImpl implements LinkEndCreationData {
	...
	public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IntermediateActionsPackage.LINK_END_CREATION_DATA__INSERT_AT, oldInsertAt, newInsertAt);
	...
	public void setInsertAt(InputPin newInsertAt) {
		if (newInsertAt != insertAt) {
			...
			if (insertAt != null)
				msgs = ((InternalEObject)insertAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IntermediateActionsPackage.LINK_END_CREATION_DATA__INSERT_AT, null, msgs);
			if (newInsertAt != null)
				msgs = ((InternalEObject)newInsertAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IntermediateActionsPackage.LINK_END_CREATION_DATA__INSERT_AT, null, msgs);
			msgs = basicSetInsertAt(newInsertAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IntermediateActionsPackage.LINK_END_CREATION_DATA__INSERT_AT, newInsertAt, newInsertAt));
	}
