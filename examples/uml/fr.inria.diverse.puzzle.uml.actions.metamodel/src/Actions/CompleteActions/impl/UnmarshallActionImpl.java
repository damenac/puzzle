 ...
 * <ul>
 *   <li>{@link Actions.CompleteActions.impl.UnmarshallActionImpl#getObject <em>Object</em>}</li>
 *   <li>{@link Actions.CompleteActions.impl.UnmarshallActionImpl#getUnmarshallType <em>Unmarshall Type</em>}</li>
 *   <li>{@link Actions.CompleteActions.impl.UnmarshallActionImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnmarshallActionImpl extends ActionImpl implements UnmarshallAction {
	...
	protected EClass eStaticClass() {
		return CompleteActionsPackage.Literals.UNMARSHALL_ACTION;
	}
	...
	public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CompleteActionsPackage.UNMARSHALL_ACTION__OBJECT, oldObject, newObject);
	...
	public void setObject(InputPin newObject) {
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject)object).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompleteActionsPackage.UNMARSHALL_ACTION__OBJECT, null, msgs);
			if (newObject != null)
				msgs = ((InternalEObject)newObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompleteActionsPackage.UNMARSHALL_ACTION__OBJECT, null, msgs);
			msgs = basicSetObject(newObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteActionsPackage.UNMARSHALL_ACTION__OBJECT, newObject, newObject));
	}
	...
	public Classifier getUnmarshallType() {
		if (unmarshallType != null && unmarshallType.eIsProxy()) {
			...
			if (unmarshallType != oldUnmarshallType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteActionsPackage.UNMARSHALL_ACTION__UNMARSHALL_TYPE, oldUnmarshallType, unmarshallType));
			}
		}
	...
	public void setUnmarshallType(Classifier newUnmarshallType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteActionsPackage.UNMARSHALL_ACTION__UNMARSHALL_TYPE, oldUnmarshallType, unmarshallType));
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, CompleteActionsPackage.UNMARSHALL_ACTION__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteActionsPackage.UNMARSHALL_ACTION__OBJECT:
				return basicSetObject(null, msgs);
			case CompleteActionsPackage.UNMARSHALL_ACTION__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteActionsPackage.UNMARSHALL_ACTION__OBJECT:
				return getObject();
			case CompleteActionsPackage.UNMARSHALL_ACTION__UNMARSHALL_TYPE:
