 ...
 * <ul>
 *   <li>{@link Actions.StructuredActions.impl.AddVariableValueActionImpl#getInsertAt <em>Insert At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddVariableValueActionImpl extends WriteVariableActionImpl implements AddVariableValueAction {
	...
	protected EClass eStaticClass() {
		return StructuredActionsPackage.Literals.ADD_VARIABLE_VALUE_ACTION;
	}
	...
	public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StructuredActionsPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, oldInsertAt, newInsertAt);
	...
	public void setInsertAt(InputPin newInsertAt) {
		if (newInsertAt != insertAt) {
			...
			if (insertAt != null)
				msgs = ((InternalEObject)insertAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StructuredActionsPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, null, msgs);
			if (newInsertAt != null)
				msgs = ((InternalEObject)newInsertAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StructuredActionsPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, null, msgs);
			msgs = basicSetInsertAt(newInsertAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredActionsPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, newInsertAt, newInsertAt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredActionsPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT:
