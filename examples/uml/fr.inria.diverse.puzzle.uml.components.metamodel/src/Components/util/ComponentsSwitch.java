...
public class ComponentsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ComponentsPackage.COMPONENT_REALIZATION: {
			...
			case ComponentsPackage.CLASS: {
				Components.Class class_ = (Components.Class)theEObject;
			...
			case ComponentsPackage.ABSTRACTION: {
			...
			case ComponentsPackage.NAMESPACE: {
			...
			case ComponentsPackage.BEHAVIOR: {
				Behavior behavior = (Behavior)theEObject;
				T result = caseBehavior(behavior);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ComponentsPackage.CONNECTOR_END: {
			...
			case ComponentsPackage.CONNECTABLE_ELEMENT: {
			...
			case ComponentsPackage.TYPED_ELEMENT: {
	 ...
	 * @generated
	 */
	public T caseClass(Components.Class object) {
		return null;
	}
