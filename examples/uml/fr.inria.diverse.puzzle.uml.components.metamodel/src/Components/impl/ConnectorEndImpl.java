...
import Components.ConnectableElement;
import Components.ConnectorEnd;
 ...
 * <ul>
 *   <li>{@link Components.impl.ConnectorEndImpl#getPartWithPort <em>Part With Port</em>}</li>
 *   <li>{@link Components.impl.ConnectorEndImpl#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorEndImpl extends MinimalEObjectImpl.Container implements ConnectorEnd {
	...
	protected EClass eStaticClass() {
		return ComponentsPackage.Literals.CONNECTOR_END;
	}
		...
		if (partWithPort != null && partWithPort.eIsProxy()) {
			...
			if (partWithPort != oldPartWithPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComponentsPackage.CONNECTOR_END__PART_WITH_PORT, oldPartWithPort, partWithPort));
			}
		}
		return partWithPort;
	}
	...
	public void setPartWithPort(Property newPartWithPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.CONNECTOR_END__PART_WITH_PORT, oldPartWithPort, partWithPort));
	}
	...
	public ConnectableElement getRole() {
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComponentsPackage.CONNECTOR_END__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	public void setRole(ConnectableElement newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.CONNECTOR_END__ROLE, oldRole, role));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentsPackage.CONNECTOR_END__PART_WITH_PORT:
				if (resolve) return getPartWithPort();
				return basicGetPartWithPort();
			case ComponentsPackage.CONNECTOR_END__ROLE:
