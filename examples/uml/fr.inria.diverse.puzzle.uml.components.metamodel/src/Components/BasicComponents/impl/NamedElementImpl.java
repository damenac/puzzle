 ...
 * <ul>
 *   <li>{@link Components.BasicComponents.impl.NamedElementImpl#getClientDependency <em>Client Dependency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedElementImpl extends MinimalEObjectImpl.Container implements NamedElement {
	...
	protected EClass eStaticClass() {
		return BasicComponentsPackage.Literals.NAMED_ELEMENT;
	}
	...
	public EList<Dependency> getClientDependency() {
		if (clientDependency == null) {
			clientDependency = new EObjectWithInverseResolvingEList.ManyInverse<Dependency>(Dependency.class, this, BasicComponentsPackage.NAMED_ELEMENT__CLIENT_DEPENDENCY, BasicComponentsPackage.DEPENDENCY__CLIENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasicComponentsPackage.NAMED_ELEMENT__CLIENT_DEPENDENCY:
