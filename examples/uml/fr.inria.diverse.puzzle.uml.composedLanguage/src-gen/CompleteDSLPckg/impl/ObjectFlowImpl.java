...
import CompleteDSLPckg.ObjectFlow;
import CompleteDSLPckg.ObjectNodeOrderingKind;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#isIsMulticast <em>Is Multicast</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#isIsMultireceive <em>Is Multireceive</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#isIsControlType <em>Is Control Type</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#getTransformation <em>Transformation</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ObjectFlowImpl#getInState <em>In State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectFlowImpl extends ActivityEdgeImpl implements ObjectFlow {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getObjectFlow();
	}
	...
	public void setIsMulticast(boolean newIsMulticast) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.OBJECT_FLOW__IS_MULTICAST, oldIsMulticast, isMulticast));
	}
	...
	public void setIsMultireceive(boolean newIsMultireceive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.OBJECT_FLOW__IS_MULTIRECEIVE, oldIsMultireceive, isMultireceive));
	}
	...
	public void setOrdering(ObjectNodeOrderingKind newOrdering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.OBJECT_FLOW__ORDERING, oldOrdering, ordering));
	}
	...
	public void setIsControlType(boolean newIsControlType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.OBJECT_FLOW__IS_CONTROL_TYPE, oldIsControlType, isControlType));
	}
	...
	public Behavior getTransformation() {
		if (transformation != null && transformation.eIsProxy()) {
			...
			if (transformation != oldTransformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.OBJECT_FLOW__TRANSFORMATION, oldTransformation, transformation));
			}
		}
	...
	public void setTransformation(Behavior newTransformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.OBJECT_FLOW__TRANSFORMATION, oldTransformation, transformation));
	}
	...
	public Behavior getSelection() {
		if (selection != null && selection.eIsProxy()) {
			...
			if (selection != oldSelection) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.OBJECT_FLOW__SELECTION, oldSelection, selection));
			}
		}
		return selection;
	}
	...
	public void setSelection(Behavior newSelection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.OBJECT_FLOW__SELECTION, oldSelection, selection));
	}
	...
	public EList<State> getInState() {
		if (inState == null) {
			inState = new EObjectResolvingEList<State>(State.class, this, CompleteDSLPckgPackage.OBJECT_FLOW__IN_STATE);
		}
		return inState;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.OBJECT_FLOW__IS_MULTICAST:
				return isIsMulticast();
			case CompleteDSLPckgPackage.OBJECT_FLOW__IS_MULTIRECEIVE:
				return isIsMultireceive();
			case CompleteDSLPckgPackage.OBJECT_FLOW__ORDERING:
				return getOrdering();
			case CompleteDSLPckgPackage.OBJECT_FLOW__IS_CONTROL_TYPE:
				return isIsControlType();
			case CompleteDSLPckgPackage.OBJECT_FLOW__TRANSFORMATION:
				if (resolve) return getTransformation();
				return basicGetTransformation();
			case CompleteDSLPckgPackage.OBJECT_FLOW__SELECTION:
				if (resolve) return getSelection();
				return basicGetSelection();
			case CompleteDSLPckgPackage.OBJECT_FLOW__IN_STATE:
				return getInState();
		}
