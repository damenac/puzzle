...
import CompleteDSLPckg.CombinedFragment;
import CompleteDSLPckg.CompleteDSLPckgPackage;
import CompleteDSLPckg.Gate;
import CompleteDSLPckg.InteractionOperand;
import CompleteDSLPckg.InteractionOperandKind;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.CombinedFragmentImpl#getInteractionOperator <em>Interaction Operator</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.CombinedFragmentImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.CombinedFragmentImpl#getCfragmentGate <em>Cfragment Gate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CombinedFragmentImpl extends EObjectImpl implements CombinedFragment {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getCombinedFragment();
	}
	...
	public void setInteractionOperator(InteractionOperandKind newInteractionOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.COMBINED_FRAGMENT__INTERACTION_OPERATOR, oldInteractionOperator, interactionOperator));
	}
	...
	public NotificationChain basicSetOperand(InteractionOperand newOperand, NotificationChain msgs) {
		...
		operand = newOperand;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.COMBINED_FRAGMENT__OPERAND, oldOperand, newOperand);
	...
	public void setOperand(InteractionOperand newOperand) {
		if (newOperand != operand) {
			...
			if (operand != null)
				msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.COMBINED_FRAGMENT__OPERAND, null, msgs);
			if (newOperand != null)
				msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.COMBINED_FRAGMENT__OPERAND, null, msgs);
			msgs = basicSetOperand(newOperand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.COMBINED_FRAGMENT__OPERAND, newOperand, newOperand));
	}
	...
	public EList<Gate> getCfragmentGate() {
		if (cfragmentGate == null) {
			cfragmentGate = new EObjectContainmentEList<Gate>(Gate.class, this, CompleteDSLPckgPackage.COMBINED_FRAGMENT__CFRAGMENT_GATE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.COMBINED_FRAGMENT__OPERAND:
				return basicSetOperand(null, msgs);
			case CompleteDSLPckgPackage.COMBINED_FRAGMENT__CFRAGMENT_GATE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.COMBINED_FRAGMENT__INTERACTION_OPERATOR:
