...
import CompleteDSLPckg.LinkEndDestructionData;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.LinkEndDestructionDataImpl#isIsDestroyDuplicates <em>Is Destroy Duplicates</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.LinkEndDestructionDataImpl#getDestroyAt <em>Destroy At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkEndDestructionDataImpl extends LinkEndDataImpl implements LinkEndDestructionData {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getLinkEndDestructionData();
	}
	...
	public void setIsDestroyDuplicates(boolean newIsDestroyDuplicates) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__IS_DESTROY_DUPLICATES, oldIsDestroyDuplicates, isDestroyDuplicates));
	}
	...
	public NotificationChain basicSetDestroyAt(InputPin newDestroyAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT, oldDestroyAt, newDestroyAt);
	...
	public void setDestroyAt(InputPin newDestroyAt) {
		if (newDestroyAt != destroyAt) {
			...
			if (destroyAt != null)
				msgs = ((InternalEObject)destroyAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT, null, msgs);
			if (newDestroyAt != null)
				msgs = ((InternalEObject)newDestroyAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT, null, msgs);
			msgs = basicSetDestroyAt(newDestroyAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT, newDestroyAt, newDestroyAt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.LINK_END_DESTRUCTION_DATA__IS_DESTROY_DUPLICATES:
