...
import CompleteDSLPckg.Continuation;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.ContinuationImpl#isSetting <em>Setting</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContinuationImpl extends InteractionFragmentImpl implements Continuation {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getContinuation();
	}
	...
	public void setSetting(boolean newSetting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.CONTINUATION__SETTING, oldSetting, setting));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.CONTINUATION__SETTING:
				return isSetting();
		}
