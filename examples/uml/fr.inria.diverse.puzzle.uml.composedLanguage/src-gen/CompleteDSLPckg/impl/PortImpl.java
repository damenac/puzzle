 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.PortImpl#isIsBehavior <em>Is Behavior</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.PortImpl#isIsService <em>Is Service</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.PortImpl#isIsConjugated <em>Is Conjugated</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.PortImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.PortImpl#getProvided <em>Provided</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.PortImpl#getRedefinedPort <em>Redefined Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortImpl extends PropertyImpl implements Port {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getPort();
	}
	...
	public void setIsBehavior(boolean newIsBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.PORT__IS_BEHAVIOR, oldIsBehavior, isBehavior));
	}
	...
	public void setIsService(boolean newIsService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.PORT__IS_SERVICE, oldIsService, isService));
	}
	...
	public void setIsConjugated(boolean newIsConjugated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.PORT__IS_CONJUGATED, oldIsConjugated, isConjugated));
	}
	...
	public EList<Interface> getRequired() {
		if (required == null) {
			required = new EObjectResolvingEList<Interface>(Interface.class, this, CompleteDSLPckgPackage.PORT__REQUIRED);
		}
		return required;
	}
	...
	public EList<Interface> getProvided() {
		if (provided == null) {
			provided = new EObjectResolvingEList<Interface>(Interface.class, this, CompleteDSLPckgPackage.PORT__PROVIDED);
		}
		return provided;
	}
	...
	public EList<Port> getRedefinedPort() {
		if (redefinedPort == null) {
			redefinedPort = new EObjectResolvingEList<Port>(Port.class, this, CompleteDSLPckgPackage.PORT__REDEFINED_PORT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.PORT__IS_BEHAVIOR:
				return isIsBehavior();
			case CompleteDSLPckgPackage.PORT__IS_SERVICE:
				return isIsService();
			case CompleteDSLPckgPackage.PORT__IS_CONJUGATED:
				return isIsConjugated();
			case CompleteDSLPckgPackage.PORT__REQUIRED:
				return getRequired();
			case CompleteDSLPckgPackage.PORT__PROVIDED:
				return getProvided();
			case CompleteDSLPckgPackage.PORT__REDEFINED_PORT:
