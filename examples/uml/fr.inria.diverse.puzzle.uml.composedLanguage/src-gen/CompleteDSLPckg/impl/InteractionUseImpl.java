...
import CompleteDSLPckg.InteractionUse;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.InteractionUseImpl#getActualGate <em>Actual Gate</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.InteractionUseImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.InteractionUseImpl#getReturnValue <em>Return Value</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.InteractionUseImpl#getReturnValueRecipient <em>Return Value Recipient</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.InteractionUseImpl#getRefersTo <em>Refers To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InteractionUseImpl extends InteractionFragmentImpl implements InteractionUse {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getInteractionUse();
	}
	...
	public EList<Gate> getActualGate() {
		if (actualGate == null) {
			actualGate = new EObjectContainmentEList<Gate>(Gate.class, this, CompleteDSLPckgPackage.INTERACTION_USE__ACTUAL_GATE);
		}
		return actualGate;
	}
	...
	public EList<ValueSpecification> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, CompleteDSLPckgPackage.INTERACTION_USE__ARGUMENT);
		}
		return argument;
	}
	...
	public NotificationChain basicSetReturnValue(ValueSpecification newReturnValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE, oldReturnValue, newReturnValue);
	...
	public void setReturnValue(ValueSpecification newReturnValue) {
		if (newReturnValue != returnValue) {
			...
			if (returnValue != null)
				msgs = ((InternalEObject)returnValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE, null, msgs);
			if (newReturnValue != null)
				msgs = ((InternalEObject)newReturnValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE, null, msgs);
			msgs = basicSetReturnValue(newReturnValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE, newReturnValue, newReturnValue));
	}
	...
	public Property getReturnValueRecipient() {
		if (returnValueRecipient != null && returnValueRecipient.eIsProxy()) {
			...
			if (returnValueRecipient != oldReturnValueRecipient) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE_RECIPIENT, oldReturnValueRecipient, returnValueRecipient));
			}
		}
	...
	public void setReturnValueRecipient(Property newReturnValueRecipient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE_RECIPIENT, oldReturnValueRecipient, returnValueRecipient));
	}
	...
	public Interaction getRefersTo() {
		if (refersTo != null && refersTo.eIsProxy()) {
			...
			if (refersTo != oldRefersTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.INTERACTION_USE__REFERS_TO, oldRefersTo, refersTo));
			}
		}
		return refersTo;
	}
	...
	public void setRefersTo(Interaction newRefersTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.INTERACTION_USE__REFERS_TO, oldRefersTo, refersTo));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.INTERACTION_USE__ACTUAL_GATE:
				return ((InternalEList<?>)getActualGate()).basicRemove(otherEnd, msgs);
			case CompleteDSLPckgPackage.INTERACTION_USE__ARGUMENT:
				return ((InternalEList<?>)getArgument()).basicRemove(otherEnd, msgs);
			case CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CompleteDSLPckgPackage.INTERACTION_USE__RETURN_VALUE_RECIPIENT:
				if (resolve) return getReturnValueRecipient();
				return basicGetReturnValueRecipient();
			case CompleteDSLPckgPackage.INTERACTION_USE__REFERS_TO:
