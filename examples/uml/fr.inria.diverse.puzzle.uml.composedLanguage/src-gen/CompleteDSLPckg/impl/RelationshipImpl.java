 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.RelationshipImpl#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RelationshipImpl extends ElementImpl implements Relationship {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getRelationship();
	}
	...
	public EList<Element> getRelatedElement() {
		if (relatedElement == null) {
			relatedElement = new EObjectResolvingEList<Element>(Element.class, this, CompleteDSLPckgPackage.RELATIONSHIP__RELATED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.RELATIONSHIP__RELATED_ELEMENT:
