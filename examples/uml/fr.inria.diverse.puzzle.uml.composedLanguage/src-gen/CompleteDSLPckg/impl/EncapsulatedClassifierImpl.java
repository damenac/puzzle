 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.EncapsulatedClassifierImpl#getOwnedPort <em>Owned Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EncapsulatedClassifierImpl extends StructuredClassifierImpl implements EncapsulatedClassifier {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getEncapsulatedClassifier();
	}
	...
	public EList<Port> getOwnedPort() {
		if (ownedPort == null) {
			ownedPort = new EObjectContainmentEList<Port>(Port.class, this, CompleteDSLPckgPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT);
		}
		return ownedPort;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT:
