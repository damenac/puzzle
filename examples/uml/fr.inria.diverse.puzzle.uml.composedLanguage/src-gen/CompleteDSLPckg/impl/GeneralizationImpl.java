 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.GeneralizationImpl#isIsSubstitutable <em>Is Substitutable</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.GeneralizationImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.GeneralizationImpl#getSpecific <em>Specific</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.GeneralizationImpl#getGeneralizationSet <em>Generalization Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationImpl extends DirectedRelationshipImpl implements Generalization {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getGeneralization();
	}
	...
	public void setIsSubstitutable(boolean newIsSubstitutable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.GENERALIZATION__IS_SUBSTITUTABLE, oldIsSubstitutable, isSubstitutable));
	}
	...
	public Classifier getGeneral() {
		if (general != null && general.eIsProxy()) {
			...
			if (general != oldGeneral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.GENERALIZATION__GENERAL, oldGeneral, general));
			}
		}
		return general;
	}
	...
	public void setGeneral(Classifier newGeneral) {
		...
		general = newGeneral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.GENERALIZATION__GENERAL, oldGeneral, general));
	}
	...
	public Classifier getSpecific() {
		if (eContainerFeatureID() != CompleteDSLPckgPackage.GENERALIZATION__SPECIFIC) return null;
	...
	public NotificationChain basicSetSpecific(Classifier newSpecific, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newSpecific, CompleteDSLPckgPackage.GENERALIZATION__SPECIFIC, msgs);
		return msgs;
	}
	...
	public void setSpecific(Classifier newSpecific) {
		if (newSpecific != eInternalContainer() || (eContainerFeatureID() != CompleteDSLPckgPackage.GENERALIZATION__SPECIFIC && newSpecific != null)) {
			...
			if (newSpecific != null)
				msgs = ((InternalEObject)newSpecific).eInverseAdd(this, CompleteDSLPckgPackage.CLASSIFIER__GENERALIZATION, Classifier.class, msgs);
			msgs = basicSetSpecific(newSpecific, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.GENERALIZATION__SPECIFIC, newSpecific, newSpecific));
	}
	...
	public EList<GeneralizationSet> getGeneralizationSet() {
		if (generalizationSet == null) {
			generalizationSet = new EObjectWithInverseResolvingEList.ManyInverse<GeneralizationSet>(GeneralizationSet.class, this, CompleteDSLPckgPackage.GENERALIZATION__GENERALIZATION_SET, CompleteDSLPckgPackage.GENERALIZATION_SET__GENERALIZATION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.GENERALIZATION__SPECIFIC:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetSpecific((Classifier)otherEnd, msgs);
			case CompleteDSLPckgPackage.GENERALIZATION__GENERALIZATION_SET:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case CompleteDSLPckgPackage.GENERALIZATION__SPECIFIC:
				return eInternalContainer().eInverseRemove(this, CompleteDSLPckgPackage.CLASSIFIER__GENERALIZATION, Classifier.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.GENERALIZATION__IS_SUBSTITUTABLE:
				return isIsSubstitutable();
			case CompleteDSLPckgPackage.GENERALIZATION__GENERAL:
