...
import CompleteDSLPckg.ExecutionSpecification;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.ExecutionSpecificationImpl#getStart <em>Start</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.ExecutionSpecificationImpl#getFinish <em>Finish</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ExecutionSpecificationImpl extends InteractionFragmentImpl implements ExecutionSpecification {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getExecutionSpecification();
	}
		...
		if (start != null && start.eIsProxy()) {
			...
			if (start != oldStart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.EXECUTION_SPECIFICATION__START, oldStart, start));
			}
		}
		return start;
	}
	...
	public void setStart(OccurenceSpecification newStart) {
		...
		start = newStart;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.EXECUTION_SPECIFICATION__START, oldStart, start));
	}
	...
	public OccurenceSpecification getFinish() {
		if (finish != null && finish.eIsProxy()) {
			...
			if (finish != oldFinish) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.EXECUTION_SPECIFICATION__FINISH, oldFinish, finish));
			}
		}
		return finish;
	}
	...
	public void setFinish(OccurenceSpecification newFinish) {
		...
		finish = newFinish;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.EXECUTION_SPECIFICATION__FINISH, oldFinish, finish));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.EXECUTION_SPECIFICATION__START:
				if (resolve) return getStart();
				return basicGetStart();
			case CompleteDSLPckgPackage.EXECUTION_SPECIFICATION__FINISH:
