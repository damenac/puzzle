...
import CompleteDSLPckg.ConsiderIgnoreFragment;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.ConsiderIgnoreFragmentImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConsiderIgnoreFragmentImpl extends CombinedFragmentImpl implements ConsiderIgnoreFragment {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getConsiderIgnoreFragment();
	}
	...
	public EList<NamedElement> getMessage() {
		if (message == null) {
			message = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, CompleteDSLPckgPackage.CONSIDER_IGNORE_FRAGMENT__MESSAGE);
		}
		return message;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.CONSIDER_IGNORE_FRAGMENT__MESSAGE:
				return getMessage();
		}
