...
import CompleteDSLPckg.LinkAction;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.LinkActionImpl#getInputValue <em>Input Value</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.LinkActionImpl#getEndData <em>End Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkActionImpl extends ActionImpl implements LinkAction {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getLinkAction();
	}
	...
	public EList<InputPin> getInputValue() {
		if (inputValue == null) {
			inputValue = new EObjectContainmentEList<InputPin>(InputPin.class, this, CompleteDSLPckgPackage.LINK_ACTION__INPUT_VALUE);
		}
		return inputValue;
	}
	...
	public EList<LinkEndData> getEndData() {
		if (endData == null) {
			endData = new EObjectContainmentEList<LinkEndData>(LinkEndData.class, this, CompleteDSLPckgPackage.LINK_ACTION__END_DATA);
		}
		return endData;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.LINK_ACTION__INPUT_VALUE:
				return ((InternalEList<?>)getInputValue()).basicRemove(otherEnd, msgs);
			case CompleteDSLPckgPackage.LINK_ACTION__END_DATA:
