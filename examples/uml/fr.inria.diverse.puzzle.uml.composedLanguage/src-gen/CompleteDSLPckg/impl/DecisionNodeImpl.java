...
import CompleteDSLPckg.DecisionNode;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.DecisionNodeImpl#getDecisionInputFlow <em>Decision Input Flow</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.DecisionNodeImpl#getDecisionInput <em>Decision Input</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecisionNodeImpl extends ControlNodeImpl implements DecisionNode {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getDecisionNode();
	}
		...
		if (decisionInputFlow != null && decisionInputFlow.eIsProxy()) {
			...
			if (decisionInputFlow != oldDecisionInputFlow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.DECISION_NODE__DECISION_INPUT_FLOW, oldDecisionInputFlow, decisionInputFlow));
			}
		}
	...
	public void setDecisionInputFlow(ObjectFlow newDecisionInputFlow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.DECISION_NODE__DECISION_INPUT_FLOW, oldDecisionInputFlow, decisionInputFlow));
	}
	...
	public Behavior getDecisionInput() {
		if (decisionInput != null && decisionInput.eIsProxy()) {
			...
			if (decisionInput != oldDecisionInput) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.DECISION_NODE__DECISION_INPUT, oldDecisionInput, decisionInput));
			}
		}
	...
	public void setDecisionInput(Behavior newDecisionInput) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.DECISION_NODE__DECISION_INPUT, oldDecisionInput, decisionInput));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.DECISION_NODE__DECISION_INPUT_FLOW:
				if (resolve) return getDecisionInputFlow();
				return basicGetDecisionInputFlow();
			case CompleteDSLPckgPackage.DECISION_NODE__DECISION_INPUT:
