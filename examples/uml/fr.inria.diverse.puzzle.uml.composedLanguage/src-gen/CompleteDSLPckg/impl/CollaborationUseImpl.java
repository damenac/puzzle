 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.CollaborationUseImpl#getType <em>Type</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.CollaborationUseImpl#getRoleBinding <em>Role Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollaborationUseImpl extends NamedElementImpl implements CollaborationUse {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getCollaborationUse();
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.COLLABORATION_USE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Collaboration newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.COLLABORATION_USE__TYPE, oldType, type));
	}
	...
	public EList<Dependency> getRoleBinding() {
		if (roleBinding == null) {
			roleBinding = new EObjectContainmentEList<Dependency>(Dependency.class, this, CompleteDSLPckgPackage.COLLABORATION_USE__ROLE_BINDING);
		}
		return roleBinding;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.COLLABORATION_USE__ROLE_BINDING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.COLLABORATION_USE__TYPE:
