...
import CompleteDSLPckg.TimeConstraint;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.TimeConstraintImpl#isFirstEvent <em>First Event</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.TimeConstraintImpl#getTimeSpecification <em>Time Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeConstraintImpl extends IntervalConstraintImpl implements TimeConstraint {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getTimeConstraint();
	}
	...
	public void setFirstEvent(boolean newFirstEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.TIME_CONSTRAINT__FIRST_EVENT, oldFirstEvent, firstEvent));
	}
	...
	public TimeInterval getTimeSpecification() {
		if (timeSpecification != null && timeSpecification.eIsProxy()) {
			...
			if (timeSpecification != oldTimeSpecification) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.TIME_CONSTRAINT__TIME_SPECIFICATION, oldTimeSpecification, timeSpecification));
			}
		}
	...
	public void setTimeSpecification(TimeInterval newTimeSpecification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.TIME_CONSTRAINT__TIME_SPECIFICATION, oldTimeSpecification, timeSpecification));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.TIME_CONSTRAINT__FIRST_EVENT:
				return isFirstEvent();
			case CompleteDSLPckgPackage.TIME_CONSTRAINT__TIME_SPECIFICATION:
