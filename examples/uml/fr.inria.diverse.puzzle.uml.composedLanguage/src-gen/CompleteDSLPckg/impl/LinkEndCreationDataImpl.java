...
import CompleteDSLPckg.LinkEndCreationData;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.LinkEndCreationDataImpl#isIsReplaceAll <em>Is Replace All</em>}</li>
 *   <li>{@link CompleteDSLPckg.impl.LinkEndCreationDataImpl#getInsertAt <em>Insert At</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkEndCreationDataImpl extends LinkEndDataImpl implements LinkEndCreationData {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getLinkEndCreationData();
	}
	...
	public void setIsReplaceAll(boolean newIsReplaceAll) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.LINK_END_CREATION_DATA__IS_REPLACE_ALL, oldIsReplaceAll, isReplaceAll));
	}
	...
	public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.LINK_END_CREATION_DATA__INSERT_AT, oldInsertAt, newInsertAt);
	...
	public void setInsertAt(InputPin newInsertAt) {
		if (newInsertAt != insertAt) {
			...
			if (insertAt != null)
				msgs = ((InternalEObject)insertAt).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.LINK_END_CREATION_DATA__INSERT_AT, null, msgs);
			if (newInsertAt != null)
				msgs = ((InternalEObject)newInsertAt).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CompleteDSLPckgPackage.LINK_END_CREATION_DATA__INSERT_AT, null, msgs);
			msgs = basicSetInsertAt(newInsertAt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.LINK_END_CREATION_DATA__INSERT_AT, newInsertAt, newInsertAt));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.LINK_END_CREATION_DATA__INSERT_AT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.LINK_END_CREATION_DATA__IS_REPLACE_ALL:
