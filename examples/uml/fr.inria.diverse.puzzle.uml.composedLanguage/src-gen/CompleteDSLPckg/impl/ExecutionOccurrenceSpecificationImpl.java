...
import CompleteDSLPckg.ExecutionOccurrenceSpecification;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.ExecutionOccurrenceSpecificationImpl#getExecution <em>Execution</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecutionOccurrenceSpecificationImpl extends OccurenceSpecificationImpl implements ExecutionOccurrenceSpecification {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getExecutionOccurrenceSpecification();
	}
		...
		if (execution != null && execution.eIsProxy()) {
			...
			if (execution != oldExecution) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION, oldExecution, execution));
			}
		}
		return execution;
	}
	...
	public void setExecution(ExecutionSpecification newExecution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION, oldExecution, execution));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.EXECUTION_OCCURRENCE_SPECIFICATION__EXECUTION:
