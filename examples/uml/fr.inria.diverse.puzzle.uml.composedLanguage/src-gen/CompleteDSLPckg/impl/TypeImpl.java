 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.TypeImpl#getPackage <em>Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypeImpl extends PackageableElementImpl implements Type {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getType();
	}
	...
	public CompleteDSLPckg.Package getPackage() {
		if (eContainerFeatureID() != CompleteDSLPckgPackage.TYPE__PACKAGE) return null;
	...
	public NotificationChain basicSetPackage(CompleteDSLPckg.Package newPackage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPackage, CompleteDSLPckgPackage.TYPE__PACKAGE, msgs);
		return msgs;
	}
	...
	public void setPackage(CompleteDSLPckg.Package newPackage) {
		if (newPackage != eInternalContainer() || (eContainerFeatureID() != CompleteDSLPckgPackage.TYPE__PACKAGE && newPackage != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.TYPE__PACKAGE, newPackage, newPackage));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.TYPE__PACKAGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
