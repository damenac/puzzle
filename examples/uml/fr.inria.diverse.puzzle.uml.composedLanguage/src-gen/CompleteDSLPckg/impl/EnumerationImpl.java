 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getEnumeration();
	}
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, CompleteDSLPckgPackage.ENUMERATION__OWNED_LITERAL, CompleteDSLPckgPackage.ENUMERATION_LITERAL__ENUMERATION);
		}
		return ownedLiteral;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.ENUMERATION__OWNED_LITERAL:
