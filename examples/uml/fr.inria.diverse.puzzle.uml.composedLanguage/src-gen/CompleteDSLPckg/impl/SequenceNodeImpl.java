...
import CompleteDSLPckg.SequenceNode;
 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.SequenceNodeImpl#getExecutableNode <em>Executable Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceNodeImpl extends StructuredActivityNodeImpl implements SequenceNode {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.eINSTANCE.getSequenceNode();
	}
	...
	public EList<ExecutableNode> getExecutableNode() {
		if (executableNode == null) {
			executableNode = new EObjectContainmentEList<ExecutableNode>(ExecutableNode.class, this, CompleteDSLPckgPackage.SEQUENCE_NODE__EXECUTABLE_NODE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompleteDSLPckgPackage.SEQUENCE_NODE__EXECUTABLE_NODE:
