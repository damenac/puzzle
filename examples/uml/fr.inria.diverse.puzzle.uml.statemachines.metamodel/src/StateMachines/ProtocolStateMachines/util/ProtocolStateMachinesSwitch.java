 ...
 * @generated
 */
public class ProtocolStateMachinesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ProtocolStateMachinesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProtocolStateMachinesPackage.PROTOCOL_STATE_MACHINE: {
			...
			case ProtocolStateMachinesPackage.PROTOCOL_CONFORMANCE: {
			...
			case ProtocolStateMachinesPackage.DIRECTED_RELATIONSHIP: {
			...
			case ProtocolStateMachinesPackage.PORT: {
				Port port = (Port)theEObject;
				T result = casePort(port);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ProtocolStateMachinesPackage.INTERFACE: {
			...
			case ProtocolStateMachinesPackage.PROTOCOL_TRANSITION: {
			...
			case ProtocolStateMachinesPackage.OPERATION: {
