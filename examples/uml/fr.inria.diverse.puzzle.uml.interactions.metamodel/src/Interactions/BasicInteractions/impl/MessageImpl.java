 ...
 * <ul>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getMessageKind <em>Message Kind</em>}</li>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getMessageSort <em>Message Sort</em>}</li>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getArgument <em>Argument</em>}</li>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getSignature <em>Signature</em>}</li>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getSendEvent <em>Send Event</em>}</li>
 *   <li>{@link Interactions.BasicInteractions.impl.MessageImpl#getReceiveEvent <em>Receive Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MessageImpl extends NamedElementImpl implements Message {
	...
	protected EClass eStaticClass() {
		return BasicInteractionsPackage.Literals.MESSAGE;
	}
	...
	public void setMessageKind(MessageKind newMessageKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.MESSAGE__MESSAGE_KIND, oldMessageKind, messageKind));
	}
	...
	public void setMessageSort(MessageSort newMessageSort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.MESSAGE__MESSAGE_SORT, oldMessageSort, messageSort));
	}
	...
	public EList<ValueSpecification> getArgument() {
		if (argument == null) {
			argument = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, BasicInteractionsPackage.MESSAGE__ARGUMENT);
		}
		return argument;
	}
	...
	public Connector getConnector() {
		if (connector != null && connector.eIsProxy()) {
			...
			if (connector != oldConnector) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicInteractionsPackage.MESSAGE__CONNECTOR, oldConnector, connector));
			}
		}
		return connector;
	}
	...
	public void setConnector(Connector newConnector) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.MESSAGE__CONNECTOR, oldConnector, connector));
	}
	...
	public NamedElement getSignature() {
		if (signature != null && signature.eIsProxy()) {
			...
			if (signature != oldSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicInteractionsPackage.MESSAGE__SIGNATURE, oldSignature, signature));
			}
		}
		return signature;
	}
	...
	public void setSignature(NamedElement newSignature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.MESSAGE__SIGNATURE, oldSignature, signature));
	}
	...
	public MessageEnd getSendEvent() {
		if (sendEvent != null && sendEvent.eIsProxy()) {
			...
			if (sendEvent != oldSendEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicInteractionsPackage.MESSAGE__SEND_EVENT, oldSendEvent, sendEvent));
			}
		}
		return sendEvent;
	}
	...
	public void setSendEvent(MessageEnd newSendEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.MESSAGE__SEND_EVENT, oldSendEvent, sendEvent));
	}
	...
	public MessageEnd getReceiveEvent() {
		if (receiveEvent != null && receiveEvent.eIsProxy()) {
			...
			if (receiveEvent != oldReceiveEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicInteractionsPackage.MESSAGE__RECEIVE_EVENT, oldReceiveEvent, receiveEvent));
			}
		}
		return receiveEvent;
	}
	...
	public void setReceiveEvent(MessageEnd newReceiveEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.MESSAGE__RECEIVE_EVENT, oldReceiveEvent, receiveEvent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasicInteractionsPackage.MESSAGE__ARGUMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasicInteractionsPackage.MESSAGE__MESSAGE_KIND:
				return getMessageKind();
			case BasicInteractionsPackage.MESSAGE__MESSAGE_SORT:
				return getMessageSort();
			case BasicInteractionsPackage.MESSAGE__ARGUMENT:
				return getArgument();
			case BasicInteractionsPackage.MESSAGE__CONNECTOR:
				if (resolve) return getConnector();
				return basicGetConnector();
			case BasicInteractionsPackage.MESSAGE__SIGNATURE:
				if (resolve) return getSignature();
				return basicGetSignature();
			case BasicInteractionsPackage.MESSAGE__SEND_EVENT:
				if (resolve) return getSendEvent();
				return basicGetSendEvent();
			case BasicInteractionsPackage.MESSAGE__RECEIVE_EVENT:
