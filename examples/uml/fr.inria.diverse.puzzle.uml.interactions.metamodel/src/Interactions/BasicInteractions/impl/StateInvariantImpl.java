 ...
 * <ul>
 *   <li>{@link Interactions.BasicInteractions.impl.StateInvariantImpl#getInvariant <em>Invariant</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateInvariantImpl extends InteractionFragmentImpl implements StateInvariant {
	...
	protected EClass eStaticClass() {
		return BasicInteractionsPackage.Literals.STATE_INVARIANT;
	}
	...
	public NotificationChain basicSetInvariant(Constraint newInvariant, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.STATE_INVARIANT__INVARIANT, oldInvariant, newInvariant);
	...
	public void setInvariant(Constraint newInvariant) {
		if (newInvariant != invariant) {
			...
			if (invariant != null)
				msgs = ((InternalEObject)invariant).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasicInteractionsPackage.STATE_INVARIANT__INVARIANT, null, msgs);
			if (newInvariant != null)
				msgs = ((InternalEObject)newInvariant).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasicInteractionsPackage.STATE_INVARIANT__INVARIANT, null, msgs);
			msgs = basicSetInvariant(newInvariant, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicInteractionsPackage.STATE_INVARIANT__INVARIANT, newInvariant, newInvariant));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasicInteractionsPackage.STATE_INVARIANT__INVARIANT:
