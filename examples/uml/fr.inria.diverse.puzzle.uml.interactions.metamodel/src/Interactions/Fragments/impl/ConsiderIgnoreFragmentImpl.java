 ...
 * <ul>
 *   <li>{@link Interactions.Fragments.impl.ConsiderIgnoreFragmentImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConsiderIgnoreFragmentImpl extends CombinedFragmentImpl implements ConsiderIgnoreFragment {
	...
	protected EClass eStaticClass() {
		return FragmentsPackage.Literals.CONSIDER_IGNORE_FRAGMENT;
	}
	...
	public EList<NamedElement> getMessage() {
		if (message == null) {
			message = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, FragmentsPackage.CONSIDER_IGNORE_FRAGMENT__MESSAGE);
		}
		return message;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FragmentsPackage.CONSIDER_IGNORE_FRAGMENT__MESSAGE:
				return getMessage();
		}
