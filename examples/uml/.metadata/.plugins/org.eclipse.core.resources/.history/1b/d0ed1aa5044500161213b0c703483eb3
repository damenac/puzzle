 ...
 * <ul>
 *   <li>{@link CompositeStructures.impl.EncapsulatedClassifierImpl#getOwnedPort <em>Owned Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EncapsulatedClassifierImpl extends StructuredClassifierImpl implements EncapsulatedClassifier {
	...
	protected EClass eStaticClass() {
		return CompositeStructuresPackage.Literals.ENCAPSULATED_CLASSIFIER;
	}
	...
	public EList<Port> getOwnedPort() {
		if (ownedPort == null) {
			ownedPort = new EObjectContainmentEList<Port>(Port.class, this, CompositeStructuresPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT);
		}
		return ownedPort;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompositeStructuresPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT:
