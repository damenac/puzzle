 ...
 * <ul>
 *   <li>{@link Classes.Relationship#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see Classes.ClassesPackage#getRelationship()
 * @model abstract="true"
 * @generated
 */
public interface Relationship extends Element {
	 ...
	 * @see Classes.ClassesPackage#getRelationship_RelatedElement()
	 * @model required="true"
	 * @generated
	 */
