 ...
 * <ul>
 *   <li>{@link CompositeStructures.InvocationActions.InvocationAction#getOnPort <em>On Port</em>}</li>
 * </ul>
 * </p>
 *
 * @see CompositeStructures.InvocationActions.InvocationActionsPackage#getInvocationAction()
 * @model abstract="true"
 * @generated
 */
public interface InvocationAction extends EObject {
	 ...
	 * @see #setOnPort(Port)
	 * @see CompositeStructures.InvocationActions.InvocationActionsPackage#getInvocationAction_OnPort()
	 * @model
	 * @generated
	 */
	Port getOnPort();
	...
	/**
	 * Sets the value of the '{@link CompositeStructures.InvocationActions.InvocationAction#getOnPort <em>On Port</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
