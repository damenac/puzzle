 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.MultiplicityElementImpl#isIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link Classes.Kernel.impl.MultiplicityElementImpl#isIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link Classes.Kernel.impl.MultiplicityElementImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link Classes.Kernel.impl.MultiplicityElementImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link Classes.Kernel.impl.MultiplicityElementImpl#getUpperValue <em>Upper Value</em>}</li>
 *   <li>{@link Classes.Kernel.impl.MultiplicityElementImpl#getLowerValue <em>Lower Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
