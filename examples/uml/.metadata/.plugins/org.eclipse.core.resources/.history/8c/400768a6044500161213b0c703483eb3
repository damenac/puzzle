 ...
 *   <li>{@link CompositeStructures.InternalStructures.impl.StructuredClassifierImpl#getOwnedAttribute <em>Owned Attribute</em>}</li>
...
public class StructuredClassifierImpl extends ClassifierImpl implements StructuredClassifier {
	...
	public EList<Property> getOwnedAttribute() {
		if (ownedAttribute == null) {
			ownedAttribute = new EObjectContainmentEList<Property>(Property.class, this, InternalStructuresPackage.STRUCTURED_CLASSIFIER__OWNED_ATTRIBUTE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case InternalStructuresPackage.STRUCTURED_CLASSIFIER__OWNED_ATTRIBUTE:
