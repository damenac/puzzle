 ...
 * <ul>
 *   <li>{@link Classes.Dependencies.Substitution#getSubstitutingClassifier <em>Substituting Classifier</em>}</li>
 *   <li>{@link Classes.Dependencies.Substitution#getContract <em>Contract</em>}</li>
 * </ul>
 * </p>
 *
 * @see Classes.Dependencies.DependenciesPackage#getSubstitution()
 * @model
 * @generated
 */
public interface Substitution extends Realization {
	 ...
	 * It is bidirectional and its opposite is '{@link Classes.Kernel.Classifier#getSubstitution <em>Substitution</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Classes.Dependencies.DependenciesPackage#getSubstitution_SubstitutingClassifier()
	 * @see Classes.Kernel.Classifier#getSubstitution
	...
	/**
	 * Sets the value of the '{@link Classes.Dependencies.Substitution#getSubstitutingClassifier <em>Substituting Classifier</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Classes.Dependencies.DependenciesPackage#getSubstitution_Contract()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Classes.Dependencies.Substitution#getContract <em>Contract</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
