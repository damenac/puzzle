 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.ElementImportImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link Classes.Kernel.impl.ElementImportImpl#getAlias <em>Alias</em>}</li>
 *   <li>{@link Classes.Kernel.impl.ElementImportImpl#getImportedElement <em>Imported Element</em>}</li>
 *   <li>{@link Classes.Kernel.impl.ElementImportImpl#getImportingNamespace <em>Importing Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
