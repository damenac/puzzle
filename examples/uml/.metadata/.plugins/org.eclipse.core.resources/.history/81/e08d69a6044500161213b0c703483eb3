 ...
 *   <li>{@link CompositeStructures.InternalStructures.StructuredClassifier#getOwnedAttribute <em>Owned Attribute</em>}</li>
...
public interface StructuredClassifier extends Classifier {
	 ...
	 * @see CompositeStructures.InternalStructures.InternalStructuresPackage#getStructuredClassifier_OwnedAttribute()
	 * @model containment="true"
	 * @generated
	 */
