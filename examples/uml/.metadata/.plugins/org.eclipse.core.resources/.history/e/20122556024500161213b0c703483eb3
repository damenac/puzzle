 ...
 * <ul>
 *   <li>{@link Classes.impl.ParameterImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link Classes.impl.ParameterImpl#getOwnedFormalParam <em>Owned Formal Param</em>}</li>
 *   <li>{@link Classes.impl.ParameterImpl#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends TypedElementImpl implements Parameter {
	...
	public void setDefault(String newDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.PARAMETER__DEFAULT, oldDefault, default_));
	}
	...
	public BehavioralFeature getOwnedFormalParam() {
		if (ownedFormalParam != null && ownedFormalParam.eIsProxy()) {
			...
			if (ownedFormalParam != oldOwnedFormalParam) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.PARAMETER__OWNED_FORMAL_PARAM, oldOwnedFormalParam, ownedFormalParam));
			}
		}
	...
	public void setOwnedFormalParam(BehavioralFeature newOwnedFormalParam) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.PARAMETER__OWNED_FORMAL_PARAM, oldOwnedFormalParam, ownedFormalParam));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.PARAMETER__DEFAULT:
				return getDefault();
			case ClassesPackage.PARAMETER__OWNED_FORMAL_PARAM:
