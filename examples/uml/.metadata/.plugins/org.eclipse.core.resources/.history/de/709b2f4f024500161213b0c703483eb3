 ...
 * <ul>
 *   <li>{@link Classes.impl.FeatureImpl#isIsStatic <em>Is Static</em>}</li>
 *   <li>{@link Classes.impl.FeatureImpl#getFeaturingClassifier <em>Featuring Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FeatureImpl extends RedefinableElementImpl implements Feature {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.FEATURE;
	}
	...
	public void setIsStatic(boolean newIsStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.FEATURE__IS_STATIC, oldIsStatic, isStatic));
	}
	...
	public EList<Classifier> getFeaturingClassifier() {
		if (featuringClassifier == null) {
			featuringClassifier = new EObjectWithInverseResolvingEList.ManyInverse<Classifier>(Classifier.class, this, ClassesPackage.FEATURE__FEATURING_CLASSIFIER, ClassesPackage.CLASSIFIER__FEATURE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClassesPackage.FEATURE__FEATURING_CLASSIFIER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.FEATURE__IS_STATIC:
				return isIsStatic();
			case ClassesPackage.FEATURE__FEATURING_CLASSIFIER:
