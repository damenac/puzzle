 ...
 * <ul>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ClassifierImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ClassifierImpl#getCollaborationUse <em>Collaboration Use</em>}</li>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ClassifierImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ClassifierImpl extends NamespaceImpl implements Classifier {
	...
	protected EClass eStaticClass() {
		return InternalStructuresPackage.Literals.CLASSIFIER;
	}
	...
	public EList<Feature> getFeature() {
		if (feature == null) {
			feature = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(Feature.class, this, InternalStructuresPackage.CLASSIFIER__FEATURE, InternalStructuresPackage.FEATURE__FEATURING_CLASSIFIER);
		}
		return feature;
	}
	...
	public EList<CollaborationUse> getCollaborationUse() {
		if (collaborationUse == null) {
			collaborationUse = new EObjectContainmentEList<CollaborationUse>(CollaborationUse.class, this, InternalStructuresPackage.CLASSIFIER__COLLABORATION_USE);
		}
		...
		if (representation != null && representation.eIsProxy()) {
			...
			if (representation != oldRepresentation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InternalStructuresPackage.CLASSIFIER__REPRESENTATION, oldRepresentation, representation));
			}
		}
	...
	public void setRepresentation(CollaborationUse newRepresentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalStructuresPackage.CLASSIFIER__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InternalStructuresPackage.CLASSIFIER__FEATURE:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case InternalStructuresPackage.CLASSIFIER__COLLABORATION_USE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InternalStructuresPackage.CLASSIFIER__REPRESENTATION:
