 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.DirectedRelationshipImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link Classes.Kernel.impl.DirectedRelationshipImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DirectedRelationshipImpl extends RelationshipImpl implements DirectedRelationship {
	...
	protected EClass eStaticClass() {
		return KernelPackage.Literals.DIRECTED_RELATIONSHIP;
	}
	...
	public EList<Element> getTarget() {
		if (target == null) {
			target = new EObjectResolvingEList<Element>(Element.class, this, KernelPackage.DIRECTED_RELATIONSHIP__TARGET);
		}
		return target;
	}
	...
	public EList<Element> getSource() {
		if (source == null) {
			source = new EObjectResolvingEList<Element>(Element.class, this, KernelPackage.DIRECTED_RELATIONSHIP__SOURCE);
		}
		return source;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelPackage.DIRECTED_RELATIONSHIP__TARGET:
				return getTarget();
			case KernelPackage.DIRECTED_RELATIONSHIP__SOURCE:
				return getSource();
		}
