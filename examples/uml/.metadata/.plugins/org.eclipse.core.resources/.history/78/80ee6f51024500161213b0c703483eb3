 ...
 * <ul>
 *   <li>{@link Classes.impl.TypeImpl#getPackage <em>Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypeImpl extends PackageableElementImpl implements Type {
	...
	public Classes.Package getPackage() {
		if (eContainerFeatureID() != ClassesPackage.TYPE__PACKAGE) return null;
	...
	public NotificationChain basicSetPackage(Classes.Package newPackage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newPackage, ClassesPackage.TYPE__PACKAGE, msgs);
		return msgs;
	}
	...
	public void setPackage(Classes.Package newPackage) {
		if (newPackage != eInternalContainer() || (eContainerFeatureID() != ClassesPackage.TYPE__PACKAGE && newPackage != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.TYPE__PACKAGE, newPackage, newPackage));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClassesPackage.TYPE__PACKAGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
