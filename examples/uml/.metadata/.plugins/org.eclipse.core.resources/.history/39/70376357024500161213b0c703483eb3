 ...
 * <ul>
 *   <li>{@link Classes.Kernel.Relationship#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see Classes.Kernel.KernelPackage#getRelationship()
 * @model abstract="true"
 * @generated
 */
public interface Relationship extends Element {
	 ...
	 * @see Classes.Kernel.KernelPackage#getRelationship_RelatedElement()
	 * @model required="true"
	 * @generated
	 */
