...
import Components.ConnectorKind;
 ...
 * <ul>
 *   <li>{@link Components.impl.ConnectorImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link Components.impl.ConnectorImpl#getEnd <em>End</em>}</li>
 *   <li>{@link Components.impl.ConnectorImpl#getContract <em>Contract</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends MinimalEObjectImpl.Container implements Connector {
	...
	public void setKind(ConnectorKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.CONNECTOR__KIND, oldKind, kind));
	}
	...
	public EList<ConnectorEnd> getEnd() {
		if (end == null) {
			end = new EObjectContainmentEList<ConnectorEnd>(ConnectorEnd.class, this, ComponentsPackage.CONNECTOR__END);
		}
		return end;
	}
	...
	public EList<Behavior> getContract() {
		if (contract == null) {
			contract = new EObjectResolvingEList<Behavior>(Behavior.class, this, ComponentsPackage.CONNECTOR__CONTRACT);
		}
		return contract;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ComponentsPackage.CONNECTOR__END:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentsPackage.CONNECTOR__KIND:
				return getKind();
			case ComponentsPackage.CONNECTOR__END:
				return getEnd();
			case ComponentsPackage.CONNECTOR__CONTRACT:
				return getContract();
		}
