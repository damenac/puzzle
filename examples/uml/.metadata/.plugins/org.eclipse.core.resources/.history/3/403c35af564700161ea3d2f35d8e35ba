 ...
 * <ul>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectorImpl#getRedefinedConnector <em>Redefined Connector</em>}</li>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectorImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends FeatureImpl implements Connector {
	...
	protected EClass eStaticClass() {
		return InternalStructuresPackage.Literals.CONNECTOR;
	}
	...
	public EList<Connector> getRedefinedConnector() {
		if (redefinedConnector == null) {
			redefinedConnector = new EObjectResolvingEList<Connector>(Connector.class, this, InternalStructuresPackage.CONNECTOR__REDEFINED_CONNECTOR);
		}
	...
	public EList<ConnectorEnd> getEnd() {
		if (end == null) {
			end = new EObjectContainmentEList<ConnectorEnd>(ConnectorEnd.class, this, InternalStructuresPackage.CONNECTOR__END);
		}
		return end;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InternalStructuresPackage.CONNECTOR__END:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalStructuresPackage.CONNECTOR__REDEFINED_CONNECTOR:
