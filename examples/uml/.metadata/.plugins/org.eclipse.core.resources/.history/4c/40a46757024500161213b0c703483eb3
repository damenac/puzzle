 ...
 * <ul>
 *   <li>{@link Classes.Kernel.RedefinableElement#getRedefinedElement <em>Redefined Element</em>}</li>
 *   <li>{@link Classes.Kernel.RedefinableElement#isIsLeaf <em>Is Leaf</em>}</li>
 *   <li>{@link Classes.Kernel.RedefinableElement#getRedefinitionContext <em>Redefinition Context</em>}</li>
 * </ul>
 * </p>
 *
 * @see Classes.Kernel.KernelPackage#getRedefinableElement()
 * @model abstract="true"
 * @generated
 */
public interface RedefinableElement extends NamedElement {
	 ...
	 * The list contents are of type {@link Classes.Kernel.RedefinableElement}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Classes.Kernel.KernelPackage#getRedefinableElement_RedefinedElement()
	 * @model
	 * @generated
	 */
	 ...
	 * @see Classes.Kernel.KernelPackage#getRedefinableElement_IsLeaf()
	 * @model
	 * @generated
	 */
	boolean isIsLeaf();
	...
	/**
	 * Sets the value of the '{@link Classes.Kernel.RedefinableElement#isIsLeaf <em>Is Leaf</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Classes.Kernel.KernelPackage#getRedefinableElement_RedefinitionContext()
	 * @model
	 * @generated
	 */
