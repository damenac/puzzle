 ...
 * @generated
 */
public abstract class StructuralFeatureImpl extends MinimalEObjectImpl.Container implements StructuralFeature {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return CompositeStructuresPackage.Literals.STRUCTURAL_FEATURE;
	}
