 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.FeatureImpl#isIsStatic <em>Is Static</em>}</li>
 *   <li>{@link Classes.Kernel.impl.FeatureImpl#getFeaturingClassifier <em>Featuring Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
