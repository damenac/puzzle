 ...
 * <ul>
 *   <li>{@link Components.BasicComponents.impl.DependencyImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link Components.BasicComponents.impl.DependencyImpl#getClient <em>Client</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DependencyImpl extends MinimalEObjectImpl.Container implements Dependency {
	...
	protected EClass eStaticClass() {
		return BasicComponentsPackage.Literals.DEPENDENCY;
	}
	...
	public EList<NamedElement> getSupplier() {
		if (supplier == null) {
			supplier = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, BasicComponentsPackage.DEPENDENCY__SUPPLIER);
		}
		return supplier;
	}
	...
	public EList<NamedElement> getClient() {
		if (client == null) {
			client = new EObjectWithInverseResolvingEList.ManyInverse<NamedElement>(NamedElement.class, this, BasicComponentsPackage.DEPENDENCY__CLIENT, BasicComponentsPackage.NAMED_ELEMENT__CLIENT_DEPENDENCY);
		}
		return client;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasicComponentsPackage.DEPENDENCY__CLIENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasicComponentsPackage.DEPENDENCY__SUPPLIER:
				return getSupplier();
			case BasicComponentsPackage.DEPENDENCY__CLIENT:
				return getClient();
		}
