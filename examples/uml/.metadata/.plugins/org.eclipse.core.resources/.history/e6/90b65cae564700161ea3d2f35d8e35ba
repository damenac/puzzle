 ...
 * <ul>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectorEndImpl#getType <em>Type</em>}</li>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectorEndImpl#getRole <em>Role</em>}</li>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectorEndImpl#getDefiningEnd <em>Defining End</em>}</li>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectorEndImpl#getPartWithPort <em>Part With Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorEndImpl extends MinimalEObjectImpl.Container implements ConnectorEnd {
	...
	protected EClass eStaticClass() {
		return InternalStructuresPackage.Literals.CONNECTOR_END;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InternalStructuresPackage.CONNECTOR_END__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Association newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalStructuresPackage.CONNECTOR_END__TYPE, oldType, type));
	}
	...
	public ConnectableElement getRole() {
		if (role != null && role.eIsProxy()) {
			...
			if (role != oldRole) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InternalStructuresPackage.CONNECTOR_END__ROLE, oldRole, role));
			}
		}
		return role;
	}
	...
	public NotificationChain basicSetRole(ConnectableElement newRole, NotificationChain msgs) {
		...
		role = newRole;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, InternalStructuresPackage.CONNECTOR_END__ROLE, oldRole, newRole);
	...
	public void setRole(ConnectableElement newRole) {
		if (newRole != role) {
			...
			if (role != null)
				msgs = ((InternalEObject)role).eInverseRemove(this, InternalStructuresPackage.CONNECTABLE_ELEMENT__END, ConnectableElement.class, msgs);
			if (newRole != null)
				msgs = ((InternalEObject)newRole).eInverseAdd(this, InternalStructuresPackage.CONNECTABLE_ELEMENT__END, ConnectableElement.class, msgs);
			msgs = basicSetRole(newRole, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalStructuresPackage.CONNECTOR_END__ROLE, newRole, newRole));
	}
	...
	public Property getDefiningEnd() {
		if (definingEnd != null && definingEnd.eIsProxy()) {
			...
			if (definingEnd != oldDefiningEnd) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InternalStructuresPackage.CONNECTOR_END__DEFINING_END, oldDefiningEnd, definingEnd));
			}
		}
		return definingEnd;
	}
	...
	public void setDefiningEnd(Property newDefiningEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalStructuresPackage.CONNECTOR_END__DEFINING_END, oldDefiningEnd, definingEnd));
	}
	...
	public Property getPartWithPort() {
		if (partWithPort != null && partWithPort.eIsProxy()) {
			...
			if (partWithPort != oldPartWithPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InternalStructuresPackage.CONNECTOR_END__PART_WITH_PORT, oldPartWithPort, partWithPort));
			}
		}
		return partWithPort;
	}
	...
	public void setPartWithPort(Property newPartWithPort) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalStructuresPackage.CONNECTOR_END__PART_WITH_PORT, oldPartWithPort, partWithPort));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InternalStructuresPackage.CONNECTOR_END__ROLE:
				if (role != null)
					msgs = ((InternalEObject)role).eInverseRemove(this, InternalStructuresPackage.CONNECTABLE_ELEMENT__END, ConnectableElement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalStructuresPackage.CONNECTOR_END__TYPE:
				if (resolve) return getType();
				return basicGetType();
			case InternalStructuresPackage.CONNECTOR_END__ROLE:
				if (resolve) return getRole();
				return basicGetRole();
			case InternalStructuresPackage.CONNECTOR_END__DEFINING_END:
				if (resolve) return getDefiningEnd();
				return basicGetDefiningEnd();
			case InternalStructuresPackage.CONNECTOR_END__PART_WITH_PORT:
