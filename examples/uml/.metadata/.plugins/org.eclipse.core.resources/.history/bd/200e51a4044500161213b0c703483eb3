 ...
 * <ul>
 *   <li>{@link CompositeStructures.impl.InvocationActionImpl#getOnPort <em>On Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class InvocationActionImpl extends MinimalEObjectImpl.Container implements InvocationAction {
	...
	protected EClass eStaticClass() {
		return CompositeStructuresPackage.Literals.INVOCATION_ACTION;
	}
		...
		if (onPort != null && onPort.eIsProxy()) {
			...
			if (onPort != oldOnPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompositeStructuresPackage.INVOCATION_ACTION__ON_PORT, oldOnPort, onPort));
			}
		}
		return onPort;
	}
	...
	public void setOnPort(Port newOnPort) {
		...
		onPort = newOnPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompositeStructuresPackage.INVOCATION_ACTION__ON_PORT, oldOnPort, onPort));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompositeStructuresPackage.INVOCATION_ACTION__ON_PORT:
