 ...
 * <ul>
 *   <li>{@link CompositeStructures.InternalStructures.impl.ConnectableElementImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConnectableElementImpl extends TypedElementImpl implements ConnectableElement {
	...
	protected EClass eStaticClass() {
		return InternalStructuresPackage.Literals.CONNECTABLE_ELEMENT;
	}
	...
	public EList<ConnectorEnd> getEnd() {
		if (end == null) {
			end = new EObjectWithInverseResolvingEList<ConnectorEnd>(ConnectorEnd.class, this, InternalStructuresPackage.CONNECTABLE_ELEMENT__END, InternalStructuresPackage.CONNECTOR_END__ROLE);
		}
		return end;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InternalStructuresPackage.CONNECTABLE_ELEMENT__END:
