 ...
 * <ul>
 *   <li>{@link CompositeStructures.impl.PropertyImpl#getEnd <em>End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PropertyImpl extends StructuralFeatureImpl implements Property {
	...
	protected EClass eStaticClass() {
		return CompositeStructuresPackage.Literals.PROPERTY;
	}
	...
	public EList<ConnectorEnd> getEnd() {
		if (end == null) {
			end = new EObjectWithInverseResolvingEList<ConnectorEnd>(ConnectorEnd.class, this, CompositeStructuresPackage.PROPERTY__END, CompositeStructuresPackage.CONNECTOR_END__ROLE);
		}
		return end;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompositeStructuresPackage.PROPERTY__END:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ConnectableElement.class) {
			switch (derivedFeatureID) {
				case CompositeStructuresPackage.PROPERTY__END: return CompositeStructuresPackage.CONNECTABLE_ELEMENT__END;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ConnectableElement.class) {
			switch (baseFeatureID) {
				case CompositeStructuresPackage.CONNECTABLE_ELEMENT__END: return CompositeStructuresPackage.PROPERTY__END;
				default: return -1;
			}
		}
