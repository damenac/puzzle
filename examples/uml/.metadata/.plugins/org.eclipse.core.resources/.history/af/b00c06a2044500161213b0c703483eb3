 ...
 * <ul>
 *   <li>{@link CompositeStructures.impl.TriggerImpl#getPort <em>Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TriggerImpl extends MinimalEObjectImpl.Container implements Trigger {
	...
	protected EClass eStaticClass() {
		return CompositeStructuresPackage.Literals.TRIGGER;
	}
	...
	public EList<Port> getPort() {
		if (port == null) {
			port = new EObjectResolvingEList<Port>(Port.class, this, CompositeStructuresPackage.TRIGGER__PORT);
		}
		return port;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompositeStructuresPackage.TRIGGER__PORT:
				return getPort();
		}
