 ...
 * @generated
 */
public abstract class PackageableElementImpl extends MinimalEObjectImpl.Container implements PackageableElement {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return BasicComponentsPackage.Literals.PACKAGEABLE_ELEMENT;
	}
