 ...
 * <ul>
 *   <li>{@link Classes.impl.EnumerationImpl#getOwnedLiteral <em>Owned Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends DataTypeImpl implements Enumeration {
	...
	public EList<EnumerationLiteral> getOwnedLiteral() {
		if (ownedLiteral == null) {
			ownedLiteral = new EObjectContainmentWithInverseEList<EnumerationLiteral>(EnumerationLiteral.class, this, ClassesPackage.ENUMERATION__OWNED_LITERAL, ClassesPackage.ENUMERATION_LITERAL__ENUMERATION);
		}
		return ownedLiteral;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClassesPackage.ENUMERATION__OWNED_LITERAL:
