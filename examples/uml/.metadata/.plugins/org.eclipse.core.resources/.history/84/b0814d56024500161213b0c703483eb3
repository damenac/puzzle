 ...
 * <ul>
 *   <li>{@link Classes.impl.RedefinableElementImpl#getRedefinedElement <em>Redefined Element</em>}</li>
 *   <li>{@link Classes.impl.RedefinableElementImpl#isIsLeaf <em>Is Leaf</em>}</li>
 *   <li>{@link Classes.impl.RedefinableElementImpl#getRedefinitionContext <em>Redefinition Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RedefinableElementImpl extends NamedElementImpl implements RedefinableElement {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.REDEFINABLE_ELEMENT;
	}
	...
	public EList<RedefinableElement> getRedefinedElement() {
		if (redefinedElement == null) {
			redefinedElement = new EObjectResolvingEList<RedefinableElement>(RedefinableElement.class, this, ClassesPackage.REDEFINABLE_ELEMENT__REDEFINED_ELEMENT);
		}
	...
	public void setIsLeaf(boolean newIsLeaf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.REDEFINABLE_ELEMENT__IS_LEAF, oldIsLeaf, isLeaf));
	}
	...
	public EList<Classifier> getRedefinitionContext() {
		if (redefinitionContext == null) {
			redefinitionContext = new EObjectResolvingEList<Classifier>(Classifier.class, this, ClassesPackage.REDEFINABLE_ELEMENT__REDEFINITION_CONTEXT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.REDEFINABLE_ELEMENT__REDEFINED_ELEMENT:
				return getRedefinedElement();
			case ClassesPackage.REDEFINABLE_ELEMENT__IS_LEAF:
				return isIsLeaf();
			case ClassesPackage.REDEFINABLE_ELEMENT__REDEFINITION_CONTEXT:
