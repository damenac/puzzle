 ...
 * <ul>
 *   <li>{@link Deployments.Artifacts.Manifestation#getUtilizedElement <em>Utilized Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see Deployments.Artifacts.ArtifactsPackage#getManifestation()
 * @model
 * @generated
 */
public interface Manifestation extends Abstraction {
	 ...
	 * @see Deployments.Artifacts.ArtifactsPackage#getManifestation_UtilizedElement()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Deployments.Artifacts.Manifestation#getUtilizedElement <em>Utilized Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
