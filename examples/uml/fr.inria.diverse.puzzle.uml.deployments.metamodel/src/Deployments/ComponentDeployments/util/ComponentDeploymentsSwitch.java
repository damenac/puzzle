 ...
 * @generated
 */
public class ComponentDeploymentsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ComponentDeploymentsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ComponentDeploymentsPackage.DEPLOYMENT_SPECIFICATION: {
