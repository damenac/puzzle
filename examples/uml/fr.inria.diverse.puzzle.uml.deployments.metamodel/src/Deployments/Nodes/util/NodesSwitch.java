...
public class NodesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NodesPackage.CLASS: {
				Deployments.Nodes.Class class_ = (Deployments.Nodes.Class)theEObject;
				T result = caseClass(class_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodesPackage.DEVICE: {
			...
			case NodesPackage.EXECUTION_ENVIRONMENT: {
			...
			case NodesPackage.ASSOCIATION: {
				Association association = (Association)theEObject;
				T result = caseAssociation(association);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodesPackage.COMMUNICATION_PATH: {
			...
			case NodesPackage.DEPLOYMENT_TARGET: {
			...
			case NodesPackage.INSTANCE_SPECIFICATION: {
			...
			case NodesPackage.DEPENDENCY: {
				Dependency dependency = (Dependency)theEObject;
				T result = caseDependency(dependency);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NodesPackage.DEPLOYED_ARTIFACT: {
	 ...
	 * @generated
	 */
	public T caseClass(Deployments.Nodes.Class object) {
		return null;
	}
