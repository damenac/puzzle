/**
 */
package Classes.PowerTypes.util;
 ...
 * <!-- end-user-doc -->
 * @see Classes.PowerTypes.PowerTypesPackage
 * @generated
 */
public class PowerTypesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static PowerTypesPackage modelPackage;
	 ...
	 * @generated
	 */
	public PowerTypesSwitch() {
		if (modelPackage == null) {
			modelPackage = PowerTypesPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PowerTypesPackage.GENERALIZATION_SET: {
