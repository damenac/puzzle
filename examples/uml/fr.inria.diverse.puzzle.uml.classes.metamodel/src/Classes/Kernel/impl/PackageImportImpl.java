 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.PackageImportImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link Classes.Kernel.impl.PackageImportImpl#getImportedPackage <em>Imported Package</em>}</li>
 *   <li>{@link Classes.Kernel.impl.PackageImportImpl#getImportingNamespace <em>Importing Namespace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageImportImpl extends DirectedRelationshipImpl implements PackageImport {
	 ...
	 * @ordered
	 */
	protected Classes.Kernel.Package importedPackage;
	 ...
	 * @generated
	 */
	public Classes.Kernel.Package getImportedPackage() {
		if (importedPackage != null && importedPackage.eIsProxy()) {
			InternalEObject oldImportedPackage = (InternalEObject)importedPackage;
			importedPackage = (Classes.Kernel.Package)eResolveProxy(oldImportedPackage);
	 ...
	 * @generated
	 */
	public Classes.Kernel.Package basicGetImportedPackage() {
		return importedPackage;
	}
	 ...
	 * @generated
	 */
	public void setImportedPackage(Classes.Kernel.Package newImportedPackage) {
		Classes.Kernel.Package oldImportedPackage = importedPackage;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case KernelPackage.PACKAGE_IMPORT__VISIBILITY:
				...
				return;
			case KernelPackage.PACKAGE_IMPORT__IMPORTED_PACKAGE:
				setImportedPackage((Classes.Kernel.Package)newValue);
				return;
			case KernelPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case KernelPackage.PACKAGE_IMPORT__VISIBILITY:
				...
				return;
			case KernelPackage.PACKAGE_IMPORT__IMPORTED_PACKAGE:
				setImportedPackage((Classes.Kernel.Package)null);
				return;
			case KernelPackage.PACKAGE_IMPORT__IMPORTING_NAMESPACE:
