 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.SlotImpl#getOwningInstace <em>Owning Instace</em>}</li>
 *   <li>{@link Classes.Kernel.impl.SlotImpl#getValue <em>Value</em>}</li>
 *   <li>{@link Classes.Kernel.impl.SlotImpl#getDefiningFeature <em>Defining Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlotImpl extends ElementImpl implements Slot {
	...
	public InstanceSpecification getOwningInstace() {
		if (eContainerFeatureID() != KernelPackage.SLOT__OWNING_INSTACE) return null;
	...
	public NotificationChain basicSetOwningInstace(InstanceSpecification newOwningInstace, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningInstace, KernelPackage.SLOT__OWNING_INSTACE, msgs);
		return msgs;
	}
	...
	public void setOwningInstace(InstanceSpecification newOwningInstace) {
		if (newOwningInstace != eInternalContainer() || (eContainerFeatureID() != KernelPackage.SLOT__OWNING_INSTACE && newOwningInstace != null)) {
			...
			if (newOwningInstace != null)
				msgs = ((InternalEObject)newOwningInstace).eInverseAdd(this, KernelPackage.INSTANCE_SPECIFICATION__SLOT, InstanceSpecification.class, msgs);
			msgs = basicSetOwningInstace(newOwningInstace, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KernelPackage.SLOT__OWNING_INSTACE, newOwningInstace, newOwningInstace));
	}
	...
	public EList<ValueSpecification> getValue() {
		if (value == null) {
			value = new EObjectContainmentWithInverseEList<ValueSpecification>(ValueSpecification.class, this, KernelPackage.SLOT__VALUE, KernelPackage.VALUE_SPECIFICATION__OWNING_SLOT);
		}
		return value;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case KernelPackage.SLOT__OWNING_INSTACE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
