 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#isIsOrdered <em>Is Ordered</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#isIsUnique <em>Is Unique</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#getUpper <em>Upper</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#getUpperValue <em>Upper Value</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#getLowerValue <em>Lower Value</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#getType <em>Type</em>}</li>
 *   <li>{@link Classes.Kernel.impl.StructuralFeatureImpl#isIsReadOnly <em>Is Read Only</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class StructuralFeatureImpl extends FeatureImpl implements StructuralFeature {
	...
	public void setUpperValue(ValueSpecification newUpperValue) {
		if (newUpperValue != upperValue) {
			...
			if (upperValue != null)
				msgs = ((InternalEObject)upperValue).eInverseRemove(this, KernelPackage.VALUE_SPECIFICATION__OWNING_UPPER, ValueSpecification.class, msgs);
			if (newUpperValue != null)
				msgs = ((InternalEObject)newUpperValue).eInverseAdd(this, KernelPackage.VALUE_SPECIFICATION__OWNING_UPPER, ValueSpecification.class, msgs);
	...
	public void setLowerValue(ValueSpecification newLowerValue) {
		if (newLowerValue != lowerValue) {
			NotificationChain msgs = null;
			if (lowerValue != null)
				msgs = ((InternalEObject)lowerValue).eInverseRemove(this, KernelPackage.VALUE_SPECIFICATION__OWNING_LOWER, ValueSpecification.class, msgs);
			if (newLowerValue != null)
				msgs = ((InternalEObject)newLowerValue).eInverseAdd(this, KernelPackage.VALUE_SPECIFICATION__OWNING_LOWER, ValueSpecification.class, msgs);
