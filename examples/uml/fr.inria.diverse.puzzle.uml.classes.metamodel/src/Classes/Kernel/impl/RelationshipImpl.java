 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.RelationshipImpl#getRelatedElement <em>Related Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RelationshipImpl extends ElementImpl implements Relationship {
	...
	protected EClass eStaticClass() {
		return KernelPackage.Literals.RELATIONSHIP;
	}
	...
	public EList<Element> getRelatedElement() {
		if (relatedElement == null) {
			relatedElement = new EObjectResolvingEList<Element>(Element.class, this, KernelPackage.RELATIONSHIP__RELATED_ELEMENT);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KernelPackage.RELATIONSHIP__RELATED_ELEMENT:
