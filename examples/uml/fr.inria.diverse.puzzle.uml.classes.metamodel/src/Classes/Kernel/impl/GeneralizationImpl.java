 ...
 * <ul>
 *   <li>{@link Classes.Kernel.impl.GeneralizationImpl#isIsSubstitutable <em>Is Substitutable</em>}</li>
 *   <li>{@link Classes.Kernel.impl.GeneralizationImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link Classes.Kernel.impl.GeneralizationImpl#getSpecific <em>Specific</em>}</li>
 *   <li>{@link Classes.Kernel.impl.GeneralizationImpl#getGeneralizationSet <em>Generalization Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationImpl extends DirectedRelationshipImpl implements Generalization {
	...
	public EList<GeneralizationSet> getGeneralizationSet() {
		if (generalizationSet == null) {
			generalizationSet = new EObjectWithInverseResolvingEList.ManyInverse<GeneralizationSet>(GeneralizationSet.class, this, KernelPackage.GENERALIZATION__GENERALIZATION_SET, PowerTypesPackage.GENERALIZATION_SET__GENERALIZATION);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case KernelPackage.GENERALIZATION__GENERALIZATION_SET:
