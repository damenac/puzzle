 ...
 * <ul>
 *   <li>{@link Classes.Kernel.Comment#getOwningElement <em>Owning Element</em>}</li>
 *   <li>{@link Classes.Kernel.Comment#getBody <em>Body</em>}</li>
 *   <li>{@link Classes.Kernel.Comment#getAnnotatedElement <em>Annotated Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see Classes.Kernel.KernelPackage#getComment()
 * @model
 * @generated
 */
public interface Comment extends Element {
	 ...
	 * It is bidirectional and its opposite is '{@link Classes.Kernel.Element#getOwnedComment <em>Owned Comment</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see Classes.Kernel.KernelPackage#getComment_OwningElement()
	 * @see Classes.Kernel.Element#getOwnedComment
	...
	/**
	 * Sets the value of the '{@link Classes.Kernel.Comment#getOwningElement <em>Owning Element</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBody(String)
	 * @see Classes.Kernel.KernelPackage#getComment_Body()
	 * @model
	 * @generated
	 */
	String getBody();
	...
	/**
	 * Sets the value of the '{@link Classes.Kernel.Comment#getBody <em>Body</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Classes.Kernel.KernelPackage#getComment_AnnotatedElement()
	 * @model
	 * @generated
	 */
