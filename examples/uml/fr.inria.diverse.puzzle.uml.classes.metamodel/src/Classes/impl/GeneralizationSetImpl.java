 ...
 * <ul>
 *   <li>{@link Classes.impl.GeneralizationSetImpl#isIsCovering <em>Is Covering</em>}</li>
 *   <li>{@link Classes.impl.GeneralizationSetImpl#isIsDisjoint <em>Is Disjoint</em>}</li>
 *   <li>{@link Classes.impl.GeneralizationSetImpl#getPowertype <em>Powertype</em>}</li>
 *   <li>{@link Classes.impl.GeneralizationSetImpl#getGeneralization <em>Generalization</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationSetImpl extends PackageableElementImpl implements GeneralizationSet {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.GENERALIZATION_SET;
	}
	...
	public void setIsCovering(boolean newIsCovering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.GENERALIZATION_SET__IS_COVERING, oldIsCovering, isCovering));
	}
	...
	public void setIsDisjoint(boolean newIsDisjoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.GENERALIZATION_SET__IS_DISJOINT, oldIsDisjoint, isDisjoint));
	}
	...
	public Classifier getPowertype() {
		if (powertype != null && powertype.eIsProxy()) {
			...
			if (powertype != oldPowertype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.GENERALIZATION_SET__POWERTYPE, oldPowertype, powertype));
			}
		}
		return powertype;
	}
	...
	public NotificationChain basicSetPowertype(Classifier newPowertype, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassesPackage.GENERALIZATION_SET__POWERTYPE, oldPowertype, newPowertype);
	...
	public void setPowertype(Classifier newPowertype) {
		if (newPowertype != powertype) {
			...
			if (powertype != null)
				msgs = ((InternalEObject)powertype).eInverseRemove(this, ClassesPackage.CLASSIFIER__POWERTYPE_EXTENT, Classifier.class, msgs);
			if (newPowertype != null)
				msgs = ((InternalEObject)newPowertype).eInverseAdd(this, ClassesPackage.CLASSIFIER__POWERTYPE_EXTENT, Classifier.class, msgs);
			msgs = basicSetPowertype(newPowertype, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.GENERALIZATION_SET__POWERTYPE, newPowertype, newPowertype));
	}
	...
	public EList<Generalization> getGeneralization() {
		if (generalization == null) {
			generalization = new EObjectWithInverseResolvingEList.ManyInverse<Generalization>(Generalization.class, this, ClassesPackage.GENERALIZATION_SET__GENERALIZATION, ClassesPackage.GENERALIZATION__GENERALIZATION_SET);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ClassesPackage.GENERALIZATION_SET__POWERTYPE:
				if (powertype != null)
					msgs = ((InternalEObject)powertype).eInverseRemove(this, ClassesPackage.CLASSIFIER__POWERTYPE_EXTENT, Classifier.class, msgs);
				return basicSetPowertype((Classifier)otherEnd, msgs);
			case ClassesPackage.GENERALIZATION_SET__GENERALIZATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.GENERALIZATION_SET__IS_COVERING:
				return isIsCovering();
			case ClassesPackage.GENERALIZATION_SET__IS_DISJOINT:
				return isIsDisjoint();
			case ClassesPackage.GENERALIZATION_SET__POWERTYPE:
