/**
 */
package Activities.FundamentalActivities.util;
 ...
 * <!-- end-user-doc -->
 * @see Activities.FundamentalActivities.FundamentalActivitiesPackage
 * @generated
 */
public class FundamentalActivitiesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static FundamentalActivitiesPackage modelPackage;
	 ...
	 * @generated
	 */
	public FundamentalActivitiesSwitch() {
		if (modelPackage == null) {
			modelPackage = FundamentalActivitiesPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FundamentalActivitiesPackage.ACTIVITY: {
			...
			case FundamentalActivitiesPackage.BEHAVIOR: {
			...
			case FundamentalActivitiesPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FundamentalActivitiesPackage.ACTIVITY_NODE: {
			...
			case FundamentalActivitiesPackage.ACTION: {
			...
			case FundamentalActivitiesPackage.ACTIVITY_GROUP: {
			...
			case FundamentalActivitiesPackage.NAMESPACE: {
	 ...
	 * @generated
	 */
	public T caseClass(Activities.IntermediateActivities.Class object) {
		return null;
	}
