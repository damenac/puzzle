 ...
 * <ul>
 *   <li>{@link Activities.StructuredActivities.impl.SequenceNodeImpl#getExecutableNode <em>Executable Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceNodeImpl extends StructuredActivityNodeImpl implements SequenceNode {
	...
	protected EClass eStaticClass() {
		return StructuredActivitiesPackage.Literals.SEQUENCE_NODE;
	}
	...
	public EList<ExecutableNode> getExecutableNode() {
		if (executableNode == null) {
			executableNode = new EObjectContainmentEList<ExecutableNode>(ExecutableNode.class, this, StructuredActivitiesPackage.SEQUENCE_NODE__EXECUTABLE_NODE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredActivitiesPackage.SEQUENCE_NODE__EXECUTABLE_NODE:
