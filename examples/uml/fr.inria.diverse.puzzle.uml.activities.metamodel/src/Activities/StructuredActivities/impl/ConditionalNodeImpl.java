 ...
 * <ul>
 *   <li>{@link Activities.StructuredActivities.impl.ConditionalNodeImpl#isIsDeterminate <em>Is Determinate</em>}</li>
 *   <li>{@link Activities.StructuredActivities.impl.ConditionalNodeImpl#isIsAssumed <em>Is Assumed</em>}</li>
 *   <li>{@link Activities.StructuredActivities.impl.ConditionalNodeImpl#getClause <em>Clause</em>}</li>
 *   <li>{@link Activities.StructuredActivities.impl.ConditionalNodeImpl#getTest <em>Test</em>}</li>
 *   <li>{@link Activities.StructuredActivities.impl.ConditionalNodeImpl#getBody <em>Body</em>}</li>
 *   <li>{@link Activities.StructuredActivities.impl.ConditionalNodeImpl#getResult <em>Result</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalNodeImpl extends StructuredActivityNodeImpl implements ConditionalNode {
	...
	protected EClass eStaticClass() {
		return StructuredActivitiesPackage.Literals.CONDITIONAL_NODE;
	}
	...
	public void setIsDeterminate(boolean newIsDeterminate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredActivitiesPackage.CONDITIONAL_NODE__IS_DETERMINATE, oldIsDeterminate, isDeterminate));
	}
	...
	public void setIsAssumed(boolean newIsAssumed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredActivitiesPackage.CONDITIONAL_NODE__IS_ASSUMED, oldIsAssumed, isAssumed));
	}
	...
	public EList<Clause> getClause() {
		if (clause == null) {
			clause = new EObjectContainmentEList<Clause>(Clause.class, this, StructuredActivitiesPackage.CONDITIONAL_NODE__CLAUSE);
		}
		return clause;
	}
	...
	public EList<ExecutableNode> getTest() {
		if (test == null) {
			test = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this, StructuredActivitiesPackage.CONDITIONAL_NODE__TEST);
		}
		return test;
	}
	...
	public EList<ExecutableNode> getBody() {
		if (body == null) {
			body = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this, StructuredActivitiesPackage.CONDITIONAL_NODE__BODY);
		}
		return body;
	}
	...
	public EList<OutputPin> getResult() {
		if (result == null) {
			result = new EObjectContainmentEList<OutputPin>(OutputPin.class, this, StructuredActivitiesPackage.CONDITIONAL_NODE__RESULT);
		}
		return result;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StructuredActivitiesPackage.CONDITIONAL_NODE__CLAUSE:
				return ((InternalEList<?>)getClause()).basicRemove(otherEnd, msgs);
			case StructuredActivitiesPackage.CONDITIONAL_NODE__RESULT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructuredActivitiesPackage.CONDITIONAL_NODE__IS_DETERMINATE:
				return isIsDeterminate();
			case StructuredActivitiesPackage.CONDITIONAL_NODE__IS_ASSUMED:
				return isIsAssumed();
			case StructuredActivitiesPackage.CONDITIONAL_NODE__CLAUSE:
				return getClause();
			case StructuredActivitiesPackage.CONDITIONAL_NODE__TEST:
				return getTest();
			case StructuredActivitiesPackage.CONDITIONAL_NODE__BODY:
				return getBody();
			case StructuredActivitiesPackage.CONDITIONAL_NODE__RESULT:
				return getResult();
		}
