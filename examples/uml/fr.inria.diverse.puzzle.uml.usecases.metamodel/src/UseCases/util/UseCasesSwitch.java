...
public class UseCasesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UseCasesPackage.BEHAVIORED_CLASSIFIER: {
			...
			case UseCasesPackage.NAMESPACE: {
				Namespace namespace = (Namespace)theEObject;
				T result = caseNamespace(namespace);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UseCasesPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UseCasesPackage.DIRECTED_RELATIONSHIP: {
			...
			case UseCasesPackage.CONSTRAINT: {
			...
			case UseCasesPackage.CLASSIFIER: {
