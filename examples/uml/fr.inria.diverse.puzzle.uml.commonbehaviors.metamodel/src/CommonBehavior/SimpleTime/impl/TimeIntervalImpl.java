 ...
 * <ul>
 *   <li>{@link CommonBehavior.SimpleTime.impl.TimeIntervalImpl#getTimeMax <em>Time Max</em>}</li>
 *   <li>{@link CommonBehavior.SimpleTime.impl.TimeIntervalImpl#getTimeMin <em>Time Min</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeIntervalImpl extends IntervalImpl implements TimeInterval {
	...
	protected EClass eStaticClass() {
		return SimpleTimePackage.Literals.TIME_INTERVAL;
	}
		...
		if (timeMax != null && timeMax.eIsProxy()) {
			...
			if (timeMax != oldTimeMax) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleTimePackage.TIME_INTERVAL__TIME_MAX, oldTimeMax, timeMax));
			}
		}
		return timeMax;
	}
	...
	public void setTimeMax(TimeExpression newTimeMax) {
		...
		timeMax = newTimeMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.TIME_INTERVAL__TIME_MAX, oldTimeMax, timeMax));
	}
	...
	public TimeExpression getTimeMin() {
		if (timeMin != null && timeMin.eIsProxy()) {
			...
			if (timeMin != oldTimeMin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleTimePackage.TIME_INTERVAL__TIME_MIN, oldTimeMin, timeMin));
			}
		}
		return timeMin;
	}
	...
	public void setTimeMin(TimeExpression newTimeMin) {
		...
		timeMin = newTimeMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.TIME_INTERVAL__TIME_MIN, oldTimeMin, timeMin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleTimePackage.TIME_INTERVAL__TIME_MAX:
				if (resolve) return getTimeMax();
				return basicGetTimeMax();
			case SimpleTimePackage.TIME_INTERVAL__TIME_MIN:
