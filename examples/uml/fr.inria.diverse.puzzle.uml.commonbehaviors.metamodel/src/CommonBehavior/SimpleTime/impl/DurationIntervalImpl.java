 ...
 * <ul>
 *   <li>{@link CommonBehavior.SimpleTime.impl.DurationIntervalImpl#getDurationMax <em>Duration Max</em>}</li>
 *   <li>{@link CommonBehavior.SimpleTime.impl.DurationIntervalImpl#getDurationMin <em>Duration Min</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationIntervalImpl extends IntervalImpl implements DurationInterval {
	...
	protected EClass eStaticClass() {
		return SimpleTimePackage.Literals.DURATION_INTERVAL;
	}
		...
		if (durationMax != null && durationMax.eIsProxy()) {
			...
			if (durationMax != oldDurationMax) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleTimePackage.DURATION_INTERVAL__DURATION_MAX, oldDurationMax, durationMax));
			}
		}
		return durationMax;
	}
	...
	public void setDurationMax(Duration newDurationMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.DURATION_INTERVAL__DURATION_MAX, oldDurationMax, durationMax));
	}
	...
	public Duration getDurationMin() {
		if (durationMin != null && durationMin.eIsProxy()) {
			...
			if (durationMin != oldDurationMin) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleTimePackage.DURATION_INTERVAL__DURATION_MIN, oldDurationMin, durationMin));
			}
		}
		return durationMin;
	}
	...
	public void setDurationMin(Duration newDurationMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.DURATION_INTERVAL__DURATION_MIN, oldDurationMin, durationMin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleTimePackage.DURATION_INTERVAL__DURATION_MAX:
				if (resolve) return getDurationMax();
				return basicGetDurationMax();
			case SimpleTimePackage.DURATION_INTERVAL__DURATION_MIN:
