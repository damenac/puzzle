 ...
 * <ul>
 *   <li>{@link CommonBehavior.SimpleTime.impl.DurationImpl#getExpr <em>Expr</em>}</li>
 *   <li>{@link CommonBehavior.SimpleTime.impl.DurationImpl#getObservation <em>Observation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DurationImpl extends ValueSpecificationImpl implements Duration {
	...
	protected EClass eStaticClass() {
		return SimpleTimePackage.Literals.DURATION;
	}
	...
	public NotificationChain basicSetExpr(ValueSpecification newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleTimePackage.DURATION__EXPR, oldExpr, newExpr);
	...
	public void setExpr(ValueSpecification newExpr) {
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleTimePackage.DURATION__EXPR, null, msgs);
			if (newExpr != null)
				msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleTimePackage.DURATION__EXPR, null, msgs);
			msgs = basicSetExpr(newExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.DURATION__EXPR, newExpr, newExpr));
	}
	...
	public EList<Observation> getObservation() {
		if (observation == null) {
			observation = new EObjectResolvingEList<Observation>(Observation.class, this, SimpleTimePackage.DURATION__OBSERVATION);
		}
		return observation;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimpleTimePackage.DURATION__EXPR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleTimePackage.DURATION__EXPR:
				return getExpr();
			case SimpleTimePackage.DURATION__OBSERVATION:
