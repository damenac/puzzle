 ...
 * <ul>
 *   <li>{@link CommonBehavior.SimpleTime.impl.TimeObservationImpl#isFirstEvent <em>First Event</em>}</li>
 *   <li>{@link CommonBehavior.SimpleTime.impl.TimeObservationImpl#getEvent <em>Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeObservationImpl extends ObservationImpl implements TimeObservation {
	...
	protected EClass eStaticClass() {
		return SimpleTimePackage.Literals.TIME_OBSERVATION;
	}
	...
	public void setFirstEvent(boolean newFirstEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.TIME_OBSERVATION__FIRST_EVENT, oldFirstEvent, firstEvent));
	}
	...
	public NamedElement getEvent() {
		if (event != null && event.eIsProxy()) {
			...
			if (event != oldEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleTimePackage.TIME_OBSERVATION__EVENT, oldEvent, event));
			}
		}
		return event;
	}
	...
	public void setEvent(NamedElement newEvent) {
		...
		event = newEvent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleTimePackage.TIME_OBSERVATION__EVENT, oldEvent, event));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SimpleTimePackage.TIME_OBSERVATION__FIRST_EVENT:
				return isFirstEvent();
			case SimpleTimePackage.TIME_OBSERVATION__EVENT:
