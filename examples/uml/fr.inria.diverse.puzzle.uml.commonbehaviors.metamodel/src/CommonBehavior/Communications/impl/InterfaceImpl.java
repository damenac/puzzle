 ...
 * <ul>
 *   <li>{@link CommonBehavior.Communications.impl.InterfaceImpl#getOwnedReception <em>Owned Reception</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterfaceImpl extends ClassifierImpl implements Interface {
	...
	protected EClass eStaticClass() {
		return CommunicationsPackage.Literals.INTERFACE;
	}
	...
	public EList<Reception> getOwnedReception() {
		if (ownedReception == null) {
			ownedReception = new EObjectContainmentEList<Reception>(Reception.class, this, CommunicationsPackage.INTERFACE__OWNED_RECEPTION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommunicationsPackage.INTERFACE__OWNED_RECEPTION:
