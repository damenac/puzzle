...
public class CommunicationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommunicationsPackage.PROPERTY: {
			...
			case CommunicationsPackage.INTERFACE: {
			...
			case CommunicationsPackage.NAMED_ELEMENT: {
			...
			case CommunicationsPackage.PACKAGEABLE_ELEMENT: {
			...
			case CommunicationsPackage.ANY_RECEIVE_EVENT: {
			...
			case CommunicationsPackage.CALL_EVENT: {
			...
			case CommunicationsPackage.OPERATION: {
				Operation operation = (Operation)theEObject;
				T result = caseOperation(operation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommunicationsPackage.CHANGE_EVENT: {
			...
			case CommunicationsPackage.VALUE_SPECIFICATION: {
