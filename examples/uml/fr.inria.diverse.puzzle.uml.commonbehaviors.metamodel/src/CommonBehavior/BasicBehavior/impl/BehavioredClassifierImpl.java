 ...
 * <ul>
 *   <li>{@link CommonBehavior.BasicBehavior.impl.BehavioredClassifierImpl#getOwnedBehavior <em>Owned Behavior</em>}</li>
 *   <li>{@link CommonBehavior.BasicBehavior.impl.BehavioredClassifierImpl#getClassifierBehavior <em>Classifier Behavior</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BehavioredClassifierImpl extends ClassifierImpl implements BehavioredClassifier {
	...
	protected EClass eStaticClass() {
		return BasicBehaviorPackage.Literals.BEHAVIORED_CLASSIFIER;
	}
	...
	public EList<Behavior> getOwnedBehavior() {
		if (ownedBehavior == null) {
			ownedBehavior = new EObjectContainmentEList<Behavior>(Behavior.class, this, BasicBehaviorPackage.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR);
		}
		...
		if (classifierBehavior != null && classifierBehavior.eIsProxy()) {
			...
			if (classifierBehavior != oldClassifierBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasicBehaviorPackage.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR, oldClassifierBehavior, classifierBehavior));
			}
		}
	...
	public void setClassifierBehavior(Behavior newClassifierBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicBehaviorPackage.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR, oldClassifierBehavior, classifierBehavior));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasicBehaviorPackage.BEHAVIORED_CLASSIFIER__OWNED_BEHAVIOR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BasicBehaviorPackage.BEHAVIORED_CLASSIFIER__CLASSIFIER_BEHAVIOR:
