 ...
 * <ul>
 *   <li>{@link CompositeStructures.impl.FeatureImpl#getFeaturingClassifier <em>Featuring Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FeatureImpl extends RedefinableElementImpl implements Feature {
	...
	protected EClass eStaticClass() {
		return CompositeStructuresPackage.Literals.FEATURE;
	}
	...
	public EList<Classifier> getFeaturingClassifier() {
		if (featuringClassifier == null) {
			featuringClassifier = new EObjectWithInverseResolvingEList.ManyInverse<Classifier>(Classifier.class, this, CompositeStructuresPackage.FEATURE__FEATURING_CLASSIFIER, CompositeStructuresPackage.CLASSIFIER__FEATURE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CompositeStructuresPackage.FEATURE__FEATURING_CLASSIFIER:
