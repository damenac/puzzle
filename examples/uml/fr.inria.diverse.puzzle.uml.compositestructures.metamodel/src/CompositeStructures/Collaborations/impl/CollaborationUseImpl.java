 ...
 * <ul>
 *   <li>{@link CompositeStructures.Collaborations.impl.CollaborationUseImpl#getType <em>Type</em>}</li>
 *   <li>{@link CompositeStructures.Collaborations.impl.CollaborationUseImpl#getRoleBinding <em>Role Binding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollaborationUseImpl extends NamedElementImpl implements CollaborationUse {
	...
	protected EClass eStaticClass() {
		return CollaborationsPackage.Literals.COLLABORATION_USE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CollaborationsPackage.COLLABORATION_USE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Collaboration newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CollaborationsPackage.COLLABORATION_USE__TYPE, oldType, type));
	}
	...
	public EList<Dependency> getRoleBinding() {
		if (roleBinding == null) {
			roleBinding = new EObjectContainmentEList<Dependency>(Dependency.class, this, CollaborationsPackage.COLLABORATION_USE__ROLE_BINDING);
		}
		return roleBinding;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CollaborationsPackage.COLLABORATION_USE__ROLE_BINDING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CollaborationsPackage.COLLABORATION_USE__TYPE:
