...
public class StateMachinesFactoryImpl extends EFactoryImpl implements StateMachinesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StateMachinesPackage.PROGRAM: return createProgram();
			case StateMachinesPackage.STATEMENT: return createStatement();
			case StateMachinesPackage.CONSTRAINT: return createConstraint();
			default:
