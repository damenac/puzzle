...
public class TfsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TfsmPackage.STATE_MACHINE: {
			...
			case TfsmPackage.ABSTRACT_STATE: {
			...
			case TfsmPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TfsmPackage.PSEUDOSTATE: {
			...
			case TfsmPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TfsmPackage.RELATIONAL_CONSTRAINT: {
			...
			case TfsmPackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TfsmPackage.PROGRAM: {
			...
			case TfsmPackage.ARITHMETIC_EXPRESSION: {
			...
			case TfsmPackage.RELATIONAL_EXPRESSION: {
			...
			case TfsmPackage.VAR_REFERENCE: {
			...
			case TfsmPackage.CONSOLE_OUTPUT: {
