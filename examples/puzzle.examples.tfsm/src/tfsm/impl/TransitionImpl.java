 ...
 * <ul>
 *   <li>{@link tfsm.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link tfsm.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link tfsm.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link tfsm.impl.TransitionImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link tfsm.impl.TransitionImpl#getTime <em>Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public NotificationChain basicSetTrigger(Trigger newTrigger, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TfsmPackage.TRANSITION__TRIGGER, oldTrigger, newTrigger);
	...
	public void setTrigger(Trigger newTrigger) {
		if (newTrigger != trigger) {
			...
			if (trigger != null)
				msgs = ((InternalEObject)trigger).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TfsmPackage.TRANSITION__TRIGGER, null, msgs);
			if (newTrigger != null)
				msgs = ((InternalEObject)newTrigger).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TfsmPackage.TRANSITION__TRIGGER, null, msgs);
			msgs = basicSetTrigger(newTrigger, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TRANSITION__TRIGGER, newTrigger, newTrigger));
	}
	...
	public void setTarget(AbstractState newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, TfsmPackage.ABSTRACT_STATE__INCOMING, AbstractState.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, TfsmPackage.ABSTRACT_STATE__INCOMING, AbstractState.class, msgs);
	...
	public void setSource(AbstractState newSource) {
		if (newSource != source) {
			NotificationChain msgs = null;
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, TfsmPackage.ABSTRACT_STATE__OUTGOING, AbstractState.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, TfsmPackage.ABSTRACT_STATE__OUTGOING, AbstractState.class, msgs);
	...
	public NotificationChain basicSetGuard(Constraint newGuard, NotificationChain msgs) {
		...
		guard = newGuard;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TfsmPackage.TRANSITION__GUARD, oldGuard, newGuard);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setGuard(Constraint newGuard) {
		if (newGuard != guard) {
			NotificationChain msgs = null;
			if (guard != null)
				msgs = ((InternalEObject)guard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TfsmPackage.TRANSITION__GUARD, null, msgs);
			if (newGuard != null)
				msgs = ((InternalEObject)newGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TfsmPackage.TRANSITION__GUARD, null, msgs);
			msgs = basicSetGuard(newGuard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TRANSITION__GUARD, newGuard, newGuard));
	}
	...
	public void setTime(int newTime) {
		...
		time = newTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TfsmPackage.TRANSITION__TIME, oldTime, time));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TfsmPackage.TRANSITION__TRIGGER:
				return basicSetTrigger(null, msgs);
			case TfsmPackage.TRANSITION__TARGET:
				return basicSetTarget(null, msgs);
			case TfsmPackage.TRANSITION__SOURCE:
				return basicSetSource(null, msgs);
			case TfsmPackage.TRANSITION__GUARD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TfsmPackage.TRANSITION__GUARD:
				return getGuard();
			case TfsmPackage.TRANSITION__TIME:
				return getTime();
		}
