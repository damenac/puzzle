 ...
 * <ul>
 *   <li>{@link tfsm.impl.RegionImpl#getSubvertex <em>Subvertex</em>}</li>
 *   <li>{@link tfsm.impl.RegionImpl#getTransitions <em>Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RegionImpl extends NamedElementImpl implements Region {
	...
	protected EClass eStaticClass() {
		return TfsmPackage.Literals.REGION;
	}
	...
	public EList<AbstractState> getSubvertex() {
		if (subvertex == null) {
			subvertex = new EObjectContainmentWithInverseEList<AbstractState>(AbstractState.class, this, TfsmPackage.REGION__SUBVERTEX, TfsmPackage.ABSTRACT_STATE__OWNER_REGION);
		}
		return subvertex;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, TfsmPackage.REGION__TRANSITIONS);
		}
		return transitions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TfsmPackage.REGION__SUBVERTEX:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case TfsmPackage.REGION__TRANSITIONS:
