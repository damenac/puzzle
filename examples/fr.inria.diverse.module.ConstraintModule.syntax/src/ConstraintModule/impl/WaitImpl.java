 ...
 * <ul>
 *   <li>{@link ConstraintModule.impl.WaitImpl#getMiliseconds <em>Miliseconds</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WaitImpl extends StatementImpl implements Wait {
	...
	protected EClass eStaticClass() {
		return ConstraintModulePackage.Literals.WAIT;
	}
	...
	public void setMiliseconds(long newMiliseconds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintModulePackage.WAIT__MILISECONDS, oldMiliseconds, miliseconds));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConstraintModulePackage.WAIT__MILISECONDS:
