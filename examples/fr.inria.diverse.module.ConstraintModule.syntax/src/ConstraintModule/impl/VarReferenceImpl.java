 ...
 * <ul>
 *   <li>{@link ConstraintModule.impl.VarReferenceImpl#getKey <em>Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VarReferenceImpl extends ExpressionImpl implements VarReference {
	...
	protected EClass eStaticClass() {
		return ConstraintModulePackage.Literals.VAR_REFERENCE;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintModulePackage.VAR_REFERENCE__KEY, oldKey, key));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ConstraintModulePackage.VAR_REFERENCE__KEY:
				return getKey();
		}
