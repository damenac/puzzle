 ...
 * @generated
 */
public class ControlStructuresSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ControlStructuresSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ControlStructuresPackage.INSTRUCTION: {
				Instruction instruction = (Instruction)theEObject;
				T result = caseInstruction(instruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ControlStructuresPackage.EXPRESSION: {
			...
			case ControlStructuresPackage.CONTROL_STRUCTURE: {
			...
			case ControlStructuresPackage.IF: {
			...
			case ControlStructuresPackage.BLOCK: {
			...
			case ControlStructuresPackage.WHILE: {
