 ...
 * @generated
 */
public class BinaryExpressionsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public BinaryExpressionsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BinaryExpressionsPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BinaryExpressionsPackage.BINARY_EXPR: {
			...
			case BinaryExpressionsPackage.ARITHMETIC_EXPR: {
			...
			case BinaryExpressionsPackage.BOOLEAN_EXPR: {
