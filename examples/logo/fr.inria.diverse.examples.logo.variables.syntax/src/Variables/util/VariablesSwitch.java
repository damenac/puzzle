...
public class VariablesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VariablesPackage.INSTRUCTION: {
				Instruction instruction = (Instruction)theEObject;
				T result = caseInstruction(instruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case VariablesPackage.EXPRESSION: {
			...
			case VariablesPackage.VAR_DECL: {
			...
			case VariablesPackage.VAR_REFERENCE: {
			...
			case VariablesPackage.ASSIGNATION: {
