 ...
 * <ul>
 *   <li>{@link Procedures.impl.ProcedureCallImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcedureCallImpl extends ExpressionImpl implements ProcedureCall {
	...
	protected EClass eStaticClass() {
		return ProceduresPackage.Literals.PROCEDURE_CALL;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProceduresPackage.PROCEDURE_CALL__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Procedure newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProceduresPackage.PROCEDURE_CALL__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProceduresPackage.PROCEDURE_CALL__REF:
