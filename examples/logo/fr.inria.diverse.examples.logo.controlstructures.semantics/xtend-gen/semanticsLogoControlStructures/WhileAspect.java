...
public class WhileAspect extends ControlStructureAspect {
  ...
  public static void evalInstruction(final While _self, final Hashtable<String, Object> context) {
  ...
  private static void super_evalInstruction(final While _self, final Hashtable<String, Object> context) {
  ...
  protected static void _privk3_evalInstruction(final WhileAspectWhileAspectProperties _self_, final While _self, final Hashtable<String, Object> context) {
