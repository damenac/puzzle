 ...
 * <ul>
 *   <li>{@link Primitives.impl.BackImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BackImpl extends PrimitiveImpl implements Back {
	...
	protected EClass eStaticClass() {
		return LogoPackage.Literals.BACK;
	}
	...
	public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.BACK__STEPS, oldSteps, newSteps);
	...
	public void setSteps(Expression newSteps) {
		if (newSteps != steps) {
			...
			if (steps != null)
				msgs = ((InternalEObject)steps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoPackage.BACK__STEPS, null, msgs);
			if (newSteps != null)
				msgs = ((InternalEObject)newSteps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoPackage.BACK__STEPS, null, msgs);
			msgs = basicSetSteps(newSteps, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoPackage.BACK__STEPS, newSteps, newSteps));
	}
