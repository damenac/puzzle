 ...
 * <ul>
 *   <li>{@link Primitives.impl.RightImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RightImpl extends PrimitiveImpl implements Right {
	...
	public NotificationChain basicSetAngle(Expression newAngle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.RIGHT__ANGLE, oldAngle, newAngle);
	...
	public void setAngle(Expression newAngle) {
		if (newAngle != angle) {
			...
			if (angle != null)
				msgs = ((InternalEObject)angle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoPackage.RIGHT__ANGLE, null, msgs);
			if (newAngle != null)
				msgs = ((InternalEObject)newAngle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoPackage.RIGHT__ANGLE, null, msgs);
