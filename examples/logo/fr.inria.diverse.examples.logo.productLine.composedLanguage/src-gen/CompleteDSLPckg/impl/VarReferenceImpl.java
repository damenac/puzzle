 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.VarReferenceImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VarReferenceImpl extends ExpressionImpl implements VarReference {
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.Literals.VAR_REFERENCE;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CompleteDSLPckgPackage.VAR_REFERENCE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(VarDecl newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.VAR_REFERENCE__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.VAR_REFERENCE__REF:
