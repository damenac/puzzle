 ...
 * <ul>
 *   <li>{@link CompleteDSLPckg.impl.BooleanExprImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BooleanExprImpl extends BinaryExprImpl implements BooleanExpr {
	/**
	...
	protected EClass eStaticClass() {
		return CompleteDSLPckgPackage.Literals.BOOLEAN_EXPR;
	}
	...
	public void setOperator(BooleanOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CompleteDSLPckgPackage.BOOLEAN_EXPR__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CompleteDSLPckgPackage.BOOLEAN_EXPR__OPERATOR:
				return getOperator();
		}
