...
public class CompleteDSLPckgSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CompleteDSLPckgPackage.VAR_REFERENCE: {
			...
			case CompleteDSLPckgPackage.CONTROL_STRUCTURE: {
			...
			case CompleteDSLPckgPackage.IF: {
			...
			case CompleteDSLPckgPackage.WHILE: {
			...
			case CompleteDSLPckgPackage.PROCEDURE: {
			...
			case CompleteDSLPckgPackage.PROCEDURE_CALL: {
