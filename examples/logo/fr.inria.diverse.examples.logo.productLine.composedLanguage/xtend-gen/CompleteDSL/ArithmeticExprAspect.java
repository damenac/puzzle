    ...
    if (_equals) {
      ...
      if (_equals_1) {
        ...
        if (_equals_2) {
          ...
          Object _eval_4 = BlockAspect.eval( _leftExpr_2,context);
          int _intValue_4 = ((Integer) _eval_4).intValue();
          Expression _rightExpr_2 = _self.getRightExpr();
          Object _eval_5 = BlockAspect.eval( _rightExpr_2,context);
          ...
          if (_equals_3) {
            ...
            Object _eval_6 = BlockAspect.eval( _leftExpr_3,context);
            int _intValue_6 = ((Integer) _eval_6).intValue();
            Expression _rightExpr_3 = _self.getRightExpr();
            Object _eval_7 = BlockAspect.eval( _rightExpr_3,context);
