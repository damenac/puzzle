...
public class BooleanExprAspectBooleanExprAspectContext {
  ...
  public static BooleanExprAspectBooleanExprAspectProperties getSelf(final BooleanExpr _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new CompleteDSL.BooleanExprAspectBooleanExprAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<BooleanExpr, BooleanExprAspectBooleanExprAspectProperties> map = new java.util.WeakHashMap<CompleteDSLPckg.BooleanExpr, CompleteDSL.BooleanExprAspectBooleanExprAspectProperties>();
