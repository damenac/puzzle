 ...
 * <ul>
 *   <li>{@link Logo.Back#getSteps <em>Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @see Logo.LogoPackage#getBack()
 * @model
 * @generated
 */
public interface Back extends Primitive {
	 ...
	 * @see Logo.LogoPackage#getBack_Steps()
	...
	/**
	 * Sets the value of the '{@link Logo.Back#getSteps <em>Steps</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
