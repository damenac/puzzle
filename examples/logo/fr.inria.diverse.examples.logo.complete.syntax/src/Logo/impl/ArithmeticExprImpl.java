 ...
 * <ul>
 *   <li>{@link Logo.impl.ArithmeticExprImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArithmeticExprImpl extends BinaryExprImpl implements ArithmeticExpr {
	...
	protected EClass eStaticClass() {
		return LogoPackage.Literals.ARITHMETIC_EXPR;
	}
	...
	public void setOperator(ArithmeticOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoPackage.ARITHMETIC_EXPR__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LogoPackage.ARITHMETIC_EXPR__OPERATOR:
				return getOperator();
		}
