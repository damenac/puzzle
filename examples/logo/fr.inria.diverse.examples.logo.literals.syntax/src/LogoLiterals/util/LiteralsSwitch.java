...
public class LiteralsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LiteralsPackage.EXPRESSION: {
			...
			case LiteralsPackage.INTEGER: {
				LogoLiterals.Integer integer = (LogoLiterals.Integer)theEObject;
			...
			case LiteralsPackage.VOID: {
				LogoLiterals.Void void_ = (LogoLiterals.Void)theEObject;
			...
			case LiteralsPackage.DOUBLE: {
				LogoLiterals.Double double_ = (LogoLiterals.Double)theEObject;
			...
			case LiteralsPackage.STRING: {
				LogoLiterals.String string = (LogoLiterals.String)theEObject;
			...
			case LiteralsPackage.BOOLEAN: {
				LogoLiterals.Boolean boolean_ = (LogoLiterals.Boolean)theEObject;
	 ...
	 * @generated
	 */
	public T caseInteger(LogoLiterals.Integer object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseVoid(LogoLiterals.Void object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDouble(LogoLiterals.Double object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseString(LogoLiterals.String object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseBoolean(LogoLiterals.Boolean object) {
		return null;
	}
