 ...
 * <ul>
 *   <li>{@link LogoProgramModule.impl.ProcCallImpl#getActualArgs <em>Actual Args</em>}</li>
 *   <li>{@link LogoProgramModule.impl.ProcCallImpl#getDeclaration <em>Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcCallImpl extends ExpressionImpl implements ProcCall {
	...
	protected EClass eStaticClass() {
		return LogoProgramModulePackage.Literals.PROC_CALL;
	}
	...
	public EList<Expression> getActualArgs() {
		if (actualArgs == null) {
			actualArgs = new EObjectContainmentEList<Expression>(Expression.class, this, LogoProgramModulePackage.PROC_CALL__ACTUAL_ARGS);
		}
		return actualArgs;
	}
		...
		if (declaration != null && declaration.eIsProxy()) {
			...
			if (declaration != oldDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogoProgramModulePackage.PROC_CALL__DECLARATION, oldDeclaration, declaration));
			}
		}
		return declaration;
	}
	...
	public void setDeclaration(ProcDeclaration newDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoProgramModulePackage.PROC_CALL__DECLARATION, oldDeclaration, declaration));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogoProgramModulePackage.PROC_CALL__ACTUAL_ARGS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LogoProgramModulePackage.PROC_CALL__DECLARATION:
