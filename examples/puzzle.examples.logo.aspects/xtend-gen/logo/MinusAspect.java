...
public class MinusAspect extends BinaryExpAspect {
  ...
  public static int eval(final Minus _self, final Context context) {
    logo.MinusAspectMinusAspectProperties _self_ = logo.MinusAspectMinusAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof kmLogo.Minus){
    result = logo.MinusAspect._privk3_eval(_self_, (kmLogo.Minus)_self,context);
  ...
  protected static int _privk3_eval(final MinusAspectMinusAspectProperties _self_, final Minus _self, final Context context) {
