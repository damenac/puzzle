...
public class RelationalExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final RelationalExpression _self, final Hashtable<String, Object> context) {
    tfsm.RelationalExpressionAspectRelationalExpressionAspectProperties _self_ = tfsm.RelationalExpressionAspectRelationalExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof tfsm.RelationalExpression){
    result = tfsm.RelationalExpressionAspect._privk3_eval(_self_, (tfsm.RelationalExpression)_self,context);
