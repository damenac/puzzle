...
import tfsm.TransitionAspectTransitionAspectProperties;
...
public class TransitionAspect {
  public static void evalTransition(final Transition _self, final Hashtable<String, Object> context) {
    tfsm.TransitionAspectTransitionAspectProperties _self_ = tfsm.TransitionAspectTransitionAspectContext.getSelf(_self);
