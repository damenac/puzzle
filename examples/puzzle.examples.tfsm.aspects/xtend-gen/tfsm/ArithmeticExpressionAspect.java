...
import tfsm.ArithmeticExpressionAspectArithmeticExpressionAspectProperties;
...
public class ArithmeticExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final ArithmeticExpression _self, final Hashtable<String, Object> context) {
    tfsm.ArithmeticExpressionAspectArithmeticExpressionAspectProperties _self_ = tfsm.ArithmeticExpressionAspectArithmeticExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof tfsm.ArithmeticExpression){
    result = tfsm.ArithmeticExpressionAspect._privk3_eval(_self_, (tfsm.ArithmeticExpression)_self,context);
