...
public class CompleteDSLPckgSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CompleteDSLPckgPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CompleteDSLPckgPackage.RELATIONAL_CONSTRAINT: {
			...
			case CompleteDSLPckgPackage.FLOWCHART: {
			...
			case CompleteDSLPckgPackage.NODE: {
			...
			case CompleteDSLPckgPackage.ARC: {
				Arc arc = (Arc)theEObject;
				T result = caseArc(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CompleteDSLPckgPackage.ACTION: {
			...
			case CompleteDSLPckgPackage.DECISION: {
			...
			case CompleteDSLPckgPackage.START: {
			...
			case CompleteDSLPckgPackage.END: {
