 ...
 * <ul>
 *   <li>{@link StateMachineModule.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends AbstractStateImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return StateMachineModulePackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachineModulePackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StateMachineModulePackage.PSEUDOSTATE__KIND:
				return getKind();
		}
