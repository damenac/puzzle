 ...
 * <ul>
 *   <li>{@link NotTriggerModule.impl.OrTriggerImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link NotTriggerModule.impl.OrTriggerImpl#getRight <em>Right</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrTriggerImpl extends TriggerImpl implements OrTrigger {
	...
	protected EClass eStaticClass() {
		return NotTriggerModulePackage.Literals.OR_TRIGGER;
	}
		...
		if (left != null && left.eIsProxy()) {
			...
			if (left != oldLeft) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NotTriggerModulePackage.OR_TRIGGER__LEFT, oldLeft, left));
			}
		}
		return left;
	}
	...
	public void setLeft(Trigger newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotTriggerModulePackage.OR_TRIGGER__LEFT, oldLeft, left));
	}
	...
	public Trigger getRight() {
		if (right != null && right.eIsProxy()) {
			...
			if (right != oldRight) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NotTriggerModulePackage.OR_TRIGGER__RIGHT, oldRight, right));
			}
		}
		return right;
	}
	...
	public void setRight(Trigger newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotTriggerModulePackage.OR_TRIGGER__RIGHT, oldRight, right));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NotTriggerModulePackage.OR_TRIGGER__LEFT:
				if (resolve) return getLeft();
				return basicGetLeft();
			case NotTriggerModulePackage.OR_TRIGGER__RIGHT:
