 ...
 * <ul>
 *   <li>{@link StateMachineModule.impl.StateMachineImpl#getRegions <em>Regions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateMachineImpl extends NamedElementImpl implements StateMachine {
	...
	public EList<Region> getRegions() {
		if (regions == null) {
			regions = new EObjectContainmentEList<Region>(Region.class, this, StateMachineModulePackage.STATE_MACHINE__REGIONS);
		}
		return regions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StateMachineModulePackage.STATE_MACHINE__REGIONS:
