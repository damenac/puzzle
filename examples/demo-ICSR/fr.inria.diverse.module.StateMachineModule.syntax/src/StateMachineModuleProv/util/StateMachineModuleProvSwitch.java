/**
 */
package StateMachineModuleProv.util;

import StateMachineModuleProv.*;
 ...
 * <!-- end-user-doc -->
 * @see StateMachineModuleProv.StateMachineModuleProvPackage
 * @generated
 */
public class StateMachineModuleProvSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static StateMachineModuleProvPackage modelPackage;
	 ...
	 * @generated
	 */
	public StateMachineModuleProvSwitch() {
		if (modelPackage == null) {
			modelPackage = StateMachineModuleProvPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StateMachineModuleProvPackage.STATE_MACHINE: {
			...
			case StateMachineModuleProvPackage.REGION: {
			...
			case StateMachineModuleProvPackage.ABSTRACT_STATE: {
			...
			case StateMachineModuleProvPackage.STATE: {
			...
			case StateMachineModuleProvPackage.TRANSITION: {
			...
			case StateMachineModuleProvPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.PSEUDOSTATE: {
			...
			case StateMachineModuleProvPackage.INITIAL_STATE: {
			...
			case StateMachineModuleProvPackage.FORK: {
				Fork fork = (Fork)theEObject;
				T result = caseFork(fork);
				if (result == null) result = casePseudostate(fork);
				if (result == null) result = caseAbstractState(fork);
				if (result == null) result = caseNamedElement(fork);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.JOIN: {
				Join join = (Join)theEObject;
				T result = caseJoin(join);
				if (result == null) result = casePseudostate(join);
				if (result == null) result = caseAbstractState(join);
				if (result == null) result = caseNamedElement(join);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.SHALLOW_HISTORY: {
				ShallowHistory shallowHistory = (ShallowHistory)theEObject;
				T result = caseShallowHistory(shallowHistory);
				if (result == null) result = casePseudostate(shallowHistory);
				if (result == null) result = caseAbstractState(shallowHistory);
				if (result == null) result = caseNamedElement(shallowHistory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.JUNCTION: {
				Junction junction = (Junction)theEObject;
				T result = caseJunction(junction);
				if (result == null) result = casePseudostate(junction);
				if (result == null) result = caseAbstractState(junction);
				if (result == null) result = caseNamedElement(junction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.FINAL_STATE: {
			...
			case StateMachineModuleProvPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StateMachineModuleProvPackage.PROGRAM: {
			...
			case StateMachineModuleProvPackage.NAMED_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Shallow History</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Shallow History</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseShallowHistory(ShallowHistory object) {
		return null;
	}
