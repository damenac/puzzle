 ...
 * @generated
 */
public class AndTriggerModuleReqSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AndTriggerModuleReqSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AndTriggerModuleReqPackage.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndTriggerModuleReqPackage.PSEUDOSTATE: {
