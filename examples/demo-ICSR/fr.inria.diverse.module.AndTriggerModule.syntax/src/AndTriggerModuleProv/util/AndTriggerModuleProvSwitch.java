 ...
 * @generated
 */
public class AndTriggerModuleProvSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AndTriggerModuleProvSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AndTriggerModuleProvPackage.AND_TRIGGER: {
			...
			case AndTriggerModuleProvPackage.DEEP_HISTORY: {
				DeepHistory deepHistory = (DeepHistory)theEObject;
				T result = caseDeepHistory(deepHistory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AndTriggerModuleProvPackage.TRIGGER: {
