 ...
 * @generated
 */
public class FmplSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FmplPackage.POLICY: {
				Policy policy = (Policy)theEObject;
				T result = casePolicy(policy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.AUTOMATA: {
				Automata automata = (Automata)theEObject;
				T result = caseAutomata(automata);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.EXEC: {
				Exec exec = (Exec)theEObject;
				T result = caseExec(exec);
				if (result == null) result = caseExpression(exec);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.COND: {
				Cond cond = (Cond)theEObject;
				T result = caseCond(cond);
				if (result == null) result = caseExpression(cond);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.READ: {
				Read read = (Read)theEObject;
				T result = caseRead(read);
				if (result == null) result = caseExpression(read);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.WRITE: {
				Write write = (Write)theEObject;
				T result = caseWrite(write);
				if (result == null) result = caseExpression(write);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FmplPackage.INIT: {
			...
			case FmplPackage.ARITHMETIC_EXPRESSION: {
			...
			case FmplPackage.VAR_DECLARATION: {
			...
			case FmplPackage.VAR_REFERENCE: {
			...
			case FmplPackage.FIELD: {
				Field field = (Field)theEObject;
				T result = caseField(field);
				if (result == null) result = caseLiteral(field);
