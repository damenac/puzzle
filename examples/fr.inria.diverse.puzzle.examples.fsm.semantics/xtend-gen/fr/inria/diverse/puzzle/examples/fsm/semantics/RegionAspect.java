...
import fr.inria.diverse.puzzle.examples.fsm.semantics.StateAspect;
import fr.inria.diverse.puzzle.examples.fsm.semantics.TransitionAspect;
import fr.inria.diverse.puzzle.examples.fsm.semantics.TriggerAspect;
...
public class RegionAspect {
  public static void initRegion(final Region _self, final Hashtable<String, Object> context) {
    fr.inria.diverse.puzzle.examples.fsm.semantics.RegionAspectRegionAspectProperties _self_ = fr.inria.diverse.puzzle.examples.fsm.semantics.RegionAspectRegionAspectContext.getSelf(_self);
