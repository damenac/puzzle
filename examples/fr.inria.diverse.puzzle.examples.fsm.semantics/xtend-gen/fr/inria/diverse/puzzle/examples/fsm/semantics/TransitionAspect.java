...
public class TransitionAspect {
  public static void evalTransition(final Transition _self, final Hashtable<String, Object> context) {
    fr.inria.diverse.puzzle.examples.fsm.semantics.TransitionAspectTransitionAspectProperties _self_ = fr.inria.diverse.puzzle.examples.fsm.semantics.TransitionAspectTransitionAspectContext.getSelf(_self);
