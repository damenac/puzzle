 ...
 * <ul>
 *   <li>{@link fsm.impl.TransitionImpl#getTrigger <em>Trigger</em>}</li>
...
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public void setTarget(AbstractState newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, FsmPackage.ABSTRACT_STATE__INCOMING, AbstractState.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, FsmPackage.ABSTRACT_STATE__INCOMING, AbstractState.class, msgs);
	...
	public void setSource(AbstractState newSource) {
		if (newSource != source) {
			NotificationChain msgs = null;
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, FsmPackage.ABSTRACT_STATE__OUTGOING, AbstractState.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, FsmPackage.ABSTRACT_STATE__OUTGOING, AbstractState.class, msgs);
	...
	public EList<Statement> getEffect() {
		if (effect == null) {
			effect = new EObjectContainmentEList<Statement>(Statement.class, this, FsmPackage.TRANSITION__EFFECT);
		}
		return effect;
	}
