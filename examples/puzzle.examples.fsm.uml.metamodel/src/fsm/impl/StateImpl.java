 ...
 * <ul>
 *   <li>{@link fsm.impl.StateImpl#getDoActivity <em>Do Activity</em>}</li>
 *   <li>{@link fsm.impl.StateImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link fsm.impl.StateImpl#getExit <em>Exit</em>}</li>
 *   <li>{@link fsm.impl.StateImpl#getOwnedRegions <em>Owned Regions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends AbstractStateImpl implements State {
	...
	public NotificationChain basicSetDoActivity(Program newDoActivity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FsmPackage.STATE__DO_ACTIVITY, oldDoActivity, newDoActivity);
	...
	public void setDoActivity(Program newDoActivity) {
		if (newDoActivity != doActivity) {
			...
			if (doActivity != null)
				msgs = ((InternalEObject)doActivity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FsmPackage.STATE__DO_ACTIVITY, null, msgs);
			if (newDoActivity != null)
				msgs = ((InternalEObject)newDoActivity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FsmPackage.STATE__DO_ACTIVITY, null, msgs);
			msgs = basicSetDoActivity(newDoActivity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.STATE__DO_ACTIVITY, newDoActivity, newDoActivity));
	}
	...
	public EList<Region> getOwnedRegions() {
		if (ownedRegions == null) {
			ownedRegions = new EObjectContainmentWithInverseEList<Region>(Region.class, this, FsmPackage.STATE__OWNED_REGIONS, FsmPackage.REGION__OWNER_STATE);
		}
		return ownedRegions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FsmPackage.STATE__OWNED_REGIONS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FsmPackage.STATE__DO_ACTIVITY:
