 ...
 * @generated
 */
public class NotTriggerModuleSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NotTriggerModulePackage.NOT_TRIGGER: {
			...
			case NotTriggerModulePackage.OR_TRIGGER: {
			...
			case NotTriggerModulePackage.TRIGGER: {
