...
import fsmumlaspects.ConstraintAspect;
import fsmumlaspects.StateAspect;
import fsmumlaspects.StatementAspect;
...
public class TransitionAspect {
  public static void evalTransition(final Transition _self, final Hashtable<String, Object> context) {
    fsmumlaspects.TransitionAspectTransitionAspectProperties _self_ = fsmumlaspects.TransitionAspectTransitionAspectContext.getSelf(_self);
