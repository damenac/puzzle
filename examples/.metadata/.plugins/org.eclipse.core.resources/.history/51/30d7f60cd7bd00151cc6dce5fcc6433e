 ...
 * @generated
 */
public class ExpressionModuleSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ExpressionModulePackage modelPackage;
	 ...
	 * @generated
	 */
	public ExpressionModuleSwitch() {
		if (modelPackage == null) {
			modelPackage = ExpressionModulePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExpressionModulePackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExpressionModulePackage.LITERAL: {
			...
			case ExpressionModulePackage.INTEGER_LIT: {
			...
			case ExpressionModulePackage.STRING_LIT: {
			...
			case ExpressionModulePackage.BOOL_LIT: {
			...
			case ExpressionModulePackage.ARITHMETIC_EXPRESSION: {
			...
			case ExpressionModulePackage.RELATIONAL_EXPRESSION: {
