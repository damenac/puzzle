...
import rhapsody.ArithmeticExpression;
import rhapsody.ArithmeticOperator;
import rhapsody.Assignation;
import rhapsody.BoolLit;
import rhapsody.Conditional;
import rhapsody.ConsoleOutput;
...
import rhapsody.Loop;
import rhapsody.NamedElement;
import rhapsody.Print;
import rhapsody.Println;
import rhapsody.Program;
import rhapsody.Pseudostate;
import rhapsody.PseudostateKind;
import rhapsody.Region;
import rhapsody.RelationalConstraint;
import rhapsody.RelationalExpression;
import rhapsody.RelationalOperator;
import rhapsody.RhapsodyFactory;
import rhapsody.RhapsodyPackage;
import rhapsody.State;
import rhapsody.StateMachine;
import rhapsody.Statement;
import rhapsody.StringLit;
import rhapsody.Transition;
import rhapsody.Trigger;
import rhapsody.VarDecl;
import rhapsody.VarReference;
import rhapsody.Wait;
 ...
 * @generated
 */
public class RhapsodyPackageImpl extends EPackageImpl implements RhapsodyPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see rhapsody.RhapsodyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RhapsodyPackageImpl() {
		super(eNS_URI, RhapsodyFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RhapsodyPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RhapsodyPackage init() {
		if (isInited) return (RhapsodyPackage)EPackage.Registry.INSTANCE.getEPackage(RhapsodyPackage.eNS_URI);

		// Obtain or create and register package
		RhapsodyPackageImpl theRhapsodyPackage = (RhapsodyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RhapsodyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RhapsodyPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theRhapsodyPackage.createPackageContents();

		// Initialize created meta-data
		theRhapsodyPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRhapsodyPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RhapsodyPackage.eNS_URI, theRhapsodyPackage);
		return theRhapsodyPackage;
	}
	 ...
	 * @generated
	 */
	public EOperation getConditional__Eval__Map() {
		return conditionalEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getLoop__Eval__Map() {
	 ...
	 * @generated
	 */
	public EOperation getVarDecl__Eval__Map() {
		return varDeclEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getExpression__ObtainValue__Map() {
	 ...
	 * @generated
	 */
	public EOperation getIntegerLit__ObtainValue__Map() {
		return integerLitEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getStringLit__ObtainValue__Map() {
		return stringLitEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getArithmeticExpression__ObtainValue__Map() {
	 ...
	 * @generated
	 */
	public RhapsodyFactory getRhapsodyFactory() {
		return (RhapsodyFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEOperation(arithmeticExpressionEClass, ARITHMETIC_EXPRESSION___OBTAIN_VALUE__MAP);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getStatement__Eval__Map(), null, "eval", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getProgram__Eval__Map(), null, "eval", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getConditional__Eval__Map(), null, "eval", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getLoop__Eval__Map(), null, "eval", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getVarDecl__Eval__Map(), null, "eval", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(expressionEClass, Expression.class, "Expression", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getExpression__ObtainValue__Map(), ecorePackage.getEJavaObject(), "obtainValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getIntegerLit__ObtainValue__Map(), ecorePackage.getEJavaObject(), "obtainValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getStringLit__ObtainValue__Map(), ecorePackage.getEJavaObject(), "obtainValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getArithmeticExpression__ObtainValue__Map(), ecorePackage.getEJavaObject(), "obtainValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEMap(), "context", 0, 1, IS_UNIQUE, IS_ORDERED);
