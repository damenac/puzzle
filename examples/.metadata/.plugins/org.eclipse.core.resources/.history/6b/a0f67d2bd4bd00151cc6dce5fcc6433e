 ...
 * <ul>
 *   <li>{@link LogoProgramModule.Left#getAngle <em>Angle</em>}</li>
 * </ul>
 * </p>
 *
 * @see LogoProgramModule.LogoProgramModulePackage#getLeft()
 * @model
 * @generated
 */
public interface Left extends Primitive {
	 ...
	 * @see LogoProgramModule.LogoProgramModulePackage#getLeft_Angle()
	...
	/**
	 * Sets the value of the '{@link LogoProgramModule.Left#getAngle <em>Angle</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
