 ...
 * <ul>
 *   <li>{@link StateMachines.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends AbstractStateImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return StateMachinesPackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StateMachinesPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StateMachinesPackage.PSEUDOSTATE__KIND:
				return getKind();
		}
