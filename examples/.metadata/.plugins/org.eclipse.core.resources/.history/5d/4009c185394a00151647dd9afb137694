 ...
 * <ul>
 *   <li>{@link fsm.impl.PseudostateImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PseudostateImpl extends AbstractStateImpl implements Pseudostate {
	...
	protected EClass eStaticClass() {
		return FsmPackage.Literals.PSEUDOSTATE;
	}
	...
	public void setKind(PseudostateKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FsmPackage.PSEUDOSTATE__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FsmPackage.PSEUDOSTATE__KIND:
				return getKind();
		}
