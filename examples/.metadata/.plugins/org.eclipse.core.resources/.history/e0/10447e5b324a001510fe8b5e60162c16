...
public class SubflowImpl extends FlowchartImpl implements Subflow {
	...
	public EList<Arc> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, FlowchartPackage.SUBFLOW__OUTGOING, FlowchartPackage.ARC__SOURCE);
		}
		return outgoing;
	}
	...
	public EList<Arc> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, FlowchartPackage.SUBFLOW__INCOMING, FlowchartPackage.ARC__TARGET);
		}
		return incoming;
	}
