 ...
 * <ul>
 *   <li>{@link simpleimperative.impl.LoopImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link simpleimperative.impl.LoopImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoopImpl extends StatementImpl implements Loop {
	...
	protected EClass eStaticClass() {
		return SimpleimperativePackage.Literals.LOOP;
	}
	...
	public NotificationChain basicSetGuard(Expression newGuard, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleimperativePackage.LOOP__GUARD, oldGuard, newGuard);
	...
	public void setGuard(Expression newGuard) {
		if (newGuard != guard) {
			...
			if (guard != null)
				msgs = ((InternalEObject)guard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleimperativePackage.LOOP__GUARD, null, msgs);
			if (newGuard != null)
				msgs = ((InternalEObject)newGuard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleimperativePackage.LOOP__GUARD, null, msgs);
			msgs = basicSetGuard(newGuard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleimperativePackage.LOOP__GUARD, newGuard, newGuard));
	}
