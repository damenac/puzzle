 ...
 * <ul>
 *   <li>{@link hfsm.State#getDoActivity <em>Do Activity</em>}</li>
 *   <li>{@link hfsm.State#getEntry <em>Entry</em>}</li>
 *   <li>{@link hfsm.State#getExit <em>Exit</em>}</li>
 * </ul>
 * </p>
 *
...
public interface State extends AbstractState {
	 ...
	 * @see hfsm.HfsmPackage#getState_DoActivity()
	...
	/**
	 * Sets the value of the '{@link hfsm.State#getDoActivity <em>Do Activity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hfsm.HfsmPackage#getState_Entry()
	 * @model containment="true"
	 * @generated
	 */
	Program getEntry();
	...
	/**
	 * Sets the value of the '{@link hfsm.State#getEntry <em>Entry</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setExit(Program)
	 * @see hfsm.HfsmPackage#getState_Exit()
	 * @model containment="true"
	 * @generated
	 */
	Program getExit();
	...
	/**
	 * Sets the value of the '{@link hfsm.State#getExit <em>Exit</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
