 ...
 * <ul>
 *   <li>{@link simpleimperative.Wait#getMiliseconds <em>Miliseconds</em>}</li>
 * </ul>
 * </p>
 *
 * @see simpleimperative.SimpleimperativePackage#getWait()
 * @model
 * @generated
 */
public interface Wait extends Statement {
	 ...
	 * @see simpleimperative.SimpleimperativePackage#getWait_Miliseconds()
	 * @model required="true"
	 * @generated
	 */
	long getMiliseconds();
	...
	/**
	 * Sets the value of the '{@link simpleimperative.Wait#getMiliseconds <em>Miliseconds</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
