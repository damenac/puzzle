 ...
 * <ul>
 *   <li>{@link Logo.impl.IfImpl#getThenPart <em>Then Part</em>}</li>
 *   <li>{@link Logo.impl.IfImpl#getElsePart <em>Else Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IfImpl extends ControlStructureImpl implements If {
	...
	public NotificationChain basicSetThenPart(Block newThenPart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.IF__THEN_PART, oldThenPart, newThenPart);
	...
	public void setThenPart(Block newThenPart) {
		if (newThenPart != thenPart) {
			...
			if (thenPart != null)
				msgs = ((InternalEObject)thenPart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoPackage.IF__THEN_PART, null, msgs);
			if (newThenPart != null)
				msgs = ((InternalEObject)newThenPart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoPackage.IF__THEN_PART, null, msgs);
	...
	public NotificationChain basicSetElsePart(Block newElsePart, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoPackage.IF__ELSE_PART, oldElsePart, newElsePart);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElsePart(Block newElsePart) {
		if (newElsePart != elsePart) {
			NotificationChain msgs = null;
			if (elsePart != null)
				msgs = ((InternalEObject)elsePart).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoPackage.IF__ELSE_PART, null, msgs);
			if (newElsePart != null)
				msgs = ((InternalEObject)newElsePart).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoPackage.IF__ELSE_PART, null, msgs);
