 ...
 * <ul>
 *   <li>{@link kmLogo.Back#getSteps <em>Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @see kmLogo.KmLogoPackage#getBack()
 * @model
 * @generated
 */
public interface Back extends Primitive {
	 ...
	 * @see kmLogo.KmLogoPackage#getBack_Steps()
	...
	/**
	 * Sets the value of the '{@link kmLogo.Back#getSteps <em>Steps</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
