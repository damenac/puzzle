 ...
 * <ul>
 *   <li>{@link kmLogo.impl.ConstantImpl#getIntegerValue <em>Integer Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstantImpl extends ExpressionImpl implements Constant {
	...
	public void setIntegerValue(int newIntegerValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KmLogoPackage.CONSTANT__INTEGER_VALUE, oldIntegerValue, integerValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case KmLogoPackage.CONSTANT__INTEGER_VALUE:
