 ...
 * <ul>
 *   <li>{@link LogoProgramModule.impl.ForwardImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForwardImpl extends PrimitiveImpl implements Forward {
	...
	protected EClass eStaticClass() {
		return LogoProgramModulePackage.Literals.FORWARD;
	}
	...
	public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LogoProgramModulePackage.FORWARD__STEPS, oldSteps, newSteps);
	...
	public void setSteps(Expression newSteps) {
		if (newSteps != steps) {
			...
			if (steps != null)
				msgs = ((InternalEObject)steps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LogoProgramModulePackage.FORWARD__STEPS, null, msgs);
			if (newSteps != null)
				msgs = ((InternalEObject)newSteps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LogoProgramModulePackage.FORWARD__STEPS, null, msgs);
			msgs = basicSetSteps(newSteps, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogoProgramModulePackage.FORWARD__STEPS, newSteps, newSteps));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LogoProgramModulePackage.FORWARD__STEPS:
