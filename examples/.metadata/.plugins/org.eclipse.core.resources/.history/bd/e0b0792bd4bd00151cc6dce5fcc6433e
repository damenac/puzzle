 ...
 * @generated
 */
public class LogoProgramModuleSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public LogoProgramModuleSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LogoProgramModulePackage.LOGO_PROGRAM: {
				LogoProgram logoProgram = (LogoProgram)theEObject;
				T result = caseLogoProgram(logoProgram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogoProgramModulePackage.INSTRUCTION: {
				Instruction instruction = (Instruction)theEObject;
				T result = caseInstruction(instruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LogoProgramModulePackage.PRIMITIVE: {
			...
			case LogoProgramModulePackage.BACK: {
			...
			case LogoProgramModulePackage.FORWARD: {
			...
			case LogoProgramModulePackage.LEFT: {
			...
			case LogoProgramModulePackage.RIGHT: {
			...
			case LogoProgramModulePackage.PEN_DOWN: {
			...
			case LogoProgramModulePackage.PEN_UP: {
			...
			case LogoProgramModulePackage.CLEAR: {
			...
			case LogoProgramModulePackage.PROC_CALL: {
			...
			case LogoProgramModulePackage.PROC_DECLARATION: {
			...
			case LogoProgramModulePackage.BLOCK: {
			...
			case LogoProgramModulePackage.IF: {
			...
			case LogoProgramModulePackage.CONTROL_STRUCTURE: {
			...
			case LogoProgramModulePackage.REPEAT: {
			...
			case LogoProgramModulePackage.WHILE: {
			...
			case LogoProgramModulePackage.PARAMETER: {
			...
			case LogoProgramModulePackage.PARAMETER_CALL: {
			...
			case LogoProgramModulePackage.EXPRESSION: {
