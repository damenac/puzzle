...
public abstract class NodeImpl extends NamedElementImpl implements Node {
	...
	public EList<Arc> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, FlowchartpckPackage.NODE__OUTGOING, FlowchartpckPackage.ARC__SOURCE);
		}
		return outgoing;
	}
	...
	public EList<Arc> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, FlowchartpckPackage.NODE__INCOMING, FlowchartpckPackage.ARC__TARGET);
		}
		return incoming;
	}
