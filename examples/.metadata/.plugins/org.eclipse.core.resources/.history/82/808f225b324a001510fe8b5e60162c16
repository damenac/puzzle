...
public abstract class NodeImpl extends MinimalEObjectImpl.Container implements Node {
	...
	public EList<Arc> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, FlowchartPackage.NODE__OUTGOING, FlowchartPackage.ARC__SOURCE);
		}
		return outgoing;
	}
	...
	public EList<Arc> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Arc>(Arc.class, this, FlowchartPackage.NODE__INCOMING, FlowchartPackage.ARC__TARGET);
		}
		return incoming;
	}
