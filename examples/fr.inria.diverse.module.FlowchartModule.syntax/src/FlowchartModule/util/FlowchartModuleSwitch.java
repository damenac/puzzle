 ...
 * @generated
 */
public class FlowchartModuleSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FlowchartModulePackage.FLOWCHART: {
				Flowchart flowchart = (Flowchart)theEObject;
				T result = caseFlowchart(flowchart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartModulePackage.NODE: {
				Node node = (Node)theEObject;
				T result = caseNode(node);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartModulePackage.ARC: {
				Arc arc = (Arc)theEObject;
				T result = caseArc(arc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartModulePackage.ACTION: {
			...
			case FlowchartModulePackage.DECISION: {
			...
			case FlowchartModulePackage.START: {
			...
			case FlowchartModulePackage.END: {
			...
			case FlowchartModulePackage.PROGRAM: {
				Program program = (Program)theEObject;
				T result = caseProgram(program);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FlowchartModulePackage.CONSTRAINT: {
