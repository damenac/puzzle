 ...
 * <ul>
 *   <li>{@link FlowchartModule.impl.NodeImpl#getName <em>Name</em>}</li>
...
public abstract class NodeImpl extends EObjectImpl implements Node {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowchartModulePackage.NODE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FlowchartModulePackage.NODE__NAME:
				return getName();
