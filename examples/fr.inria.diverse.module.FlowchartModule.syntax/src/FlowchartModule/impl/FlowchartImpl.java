 ...
 *   <li>{@link FlowchartModule.impl.FlowchartImpl#getArcs <em>Arcs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FlowchartImpl extends EObjectImpl implements Flowchart {
	...
	public EList<Arc> getArcs() {
		if (arcs == null) {
			arcs = new EObjectContainmentEList<Arc>(Arc.class, this, FlowchartModulePackage.FLOWCHART__ARCS);
		}
		return arcs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case FlowchartModulePackage.FLOWCHART__ARCS:
