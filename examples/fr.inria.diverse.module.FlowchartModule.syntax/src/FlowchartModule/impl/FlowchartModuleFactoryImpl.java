...
public class FlowchartModuleFactoryImpl extends EFactoryImpl implements FlowchartModuleFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case FlowchartModulePackage.START: return createStart();
			case FlowchartModulePackage.END: return createEnd();
			case FlowchartModulePackage.PROGRAM: return createProgram();
