 ...
 * <ul>
 *   <li>{@link FlowchartModule.impl.ActionImpl#getDoProgram <em>Do Program</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionImpl extends NodeImpl implements Action {
	...
	protected EClass eStaticClass() {
		return FlowchartModulePackage.Literals.ACTION;
	}
	...
	public NotificationChain basicSetDoProgram(Program newDoProgram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FlowchartModulePackage.ACTION__DO_PROGRAM, oldDoProgram, newDoProgram);
	...
	public void setDoProgram(Program newDoProgram) {
		if (newDoProgram != doProgram) {
			...
			if (doProgram != null)
				msgs = ((InternalEObject)doProgram).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FlowchartModulePackage.ACTION__DO_PROGRAM, null, msgs);
			if (newDoProgram != null)
				msgs = ((InternalEObject)newDoProgram).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FlowchartModulePackage.ACTION__DO_PROGRAM, null, msgs);
			msgs = basicSetDoProgram(newDoProgram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FlowchartModulePackage.ACTION__DO_PROGRAM, newDoProgram, newDoProgram));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FlowchartModulePackage.ACTION__DO_PROGRAM:
