...
public class RelationalExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final RelationalExpression _self, final Context context) {
    logo.RelationalExpressionAspectRelationalExpressionAspectProperties _self_ = logo.RelationalExpressionAspectRelationalExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof kmLogo.RelationalExpression){
    result = logo.RelationalExpressionAspect._privk3_eval(_self_, (kmLogo.RelationalExpression)_self,context);
