...
public interface FsmPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the '{@link fsm.Constraint#eval(java.util.Map) <em>Eval</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Eval</em>' operation.
	 * @see fsm.Constraint#eval(java.util.Map)
	 * @generated
	 */
	EOperation getConstraint__Eval__Map();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation CONSTRAINT___EVAL__MAP = eINSTANCE.getConstraint__Eval__Map();
