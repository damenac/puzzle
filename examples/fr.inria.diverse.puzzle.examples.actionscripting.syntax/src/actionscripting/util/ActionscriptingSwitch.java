 ...
 * @generated
 */
public class ActionscriptingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ActionscriptingPackage.BLOCK: {
				Block block = (Block)theEObject;
				T result = caseBlock(block);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionscriptingPackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ActionscriptingPackage.CONDITIONAL: {
			...
			case ActionscriptingPackage.LOOP: {
			...
			case ActionscriptingPackage.VAR_DECL: {
			...
			case ActionscriptingPackage.ASSIGNATION: {
			...
			case ActionscriptingPackage.CONSOLE_OUTPUT: {
			...
			case ActionscriptingPackage.PRINTLN: {
			...
			case ActionscriptingPackage.PRINT: {
			...
			case ActionscriptingPackage.WAIT: {
