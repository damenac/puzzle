...
import hfsm.ArithmeticExpressionAspectArithmeticExpressionAspectProperties;
...
public class ArithmeticExpressionAspect extends ExpressionAspect {
  ...
  public static Object eval(final ArithmeticExpression _self, final Hashtable<String, Object> context) {
    hfsm.ArithmeticExpressionAspectArithmeticExpressionAspectProperties _self_ = hfsm.ArithmeticExpressionAspectArithmeticExpressionAspectContext.getSelf(_self);
    Object result = null;
     if (_self instanceof hfsm.ArithmeticExpression){
    result = hfsm.ArithmeticExpressionAspect._privk3_eval(_self_, (hfsm.ArithmeticExpression)_self,context);
