...
public interface SimpleconstraintsPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the '{@link simpleconstraints.Expression#eval(java.util.Map) <em>Eval</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Eval</em>' operation.
	 * @see simpleconstraints.Expression#eval(java.util.Map)
	 * @generated
	 */
