 ...
 * <ul>
 *   <li>{@link simpleimperativeProv.Wait#getMiliseconds <em>Miliseconds</em>}</li>
 * </ul>
 * </p>
 *
 * @see simpleimperativeProv.SimpleimperativeProvPackage#getWait()
 * @model
 * @generated
 */
public interface Wait extends Statement {
	 ...
	 * @see simpleimperativeProv.SimpleimperativeProvPackage#getWait_Miliseconds()
	 * @model required="true"
	 * @generated
	 */
	long getMiliseconds();
	...
	/**
	 * Sets the value of the '{@link simpleimperativeProv.Wait#getMiliseconds <em>Miliseconds</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
